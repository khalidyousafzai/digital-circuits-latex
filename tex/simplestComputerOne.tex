...
\حصہ{ہدایات کی فہرست} 
کمپیوٹر کی با مقصد دوڑ سے قبل اس کے حافظہ  میں ہدایات قدم با قدم  بھرنا لازم ہے۔البتہ، ایسا کرنے سے پہلے  آپ کو یہ ہدایات  جاننی  ہو گی۔ان ہدایات سے مراد وہ اعمال ہیں جو یہ کمپیوٹر سرانجام دے سکتا ہے۔ اس کمپیوٹر کی ہدایات کی فہرست  پر اب غور کرتے ہیں۔ہدایات کا مجموعہ کمپیوٹر کی \اصطلاح{ مادری زبان }\فرہنگ{زبان!مادری}\فرہنگ{مادری زبان}\حاشیہب{ assembly language}\فرہنگ{language!assembly}\فرہنگ{assembly language} کہلاتا ہے۔
...
\جزوحصہء{جمع و منفی کار}
\عددی{u18} اور \عددی{u19} مخلوط دور \عددی{74LS86} ہیں۔ یہ بلا شرکت جمع گیٹ بطور قابو  کردہ  متمم کار  کا کردار ادا کرتے ہیں۔ پست \عددی{S_U} کی صورت میں  دفتر \دفترب کا مواد بغیر تبدیل ہوئے ان  گیٹ سے گزرتا ہے۔بلند \عددی{S_U} کی صورت میں \دفترب  کے مواد کا  تکملہ  \عددی{1} ان گیٹوں سے خارج ہو گا اور ساتھ ہی کمتر تر  رتبی بِٹ کے ساتھ \عددی{1} جمع ہو کر تکملہ \عددی{2} دیگا۔
...
دفتر ہدایت میں \قول{\رک}  ہدایت    بھرتے ہی  کمپیوٹر کام    کرنا  روک دیگا۔
...
جب بِٹ   \عددی{I_7I_6I_5I_4}  پتہ پختہ حافظہ   کو چلائیں،  ابتدائی پتہ پیدا ہو گا۔ مثلاً، اگر \جمع{} ہدایت زیر تعمیل ہو، \عددی{I_7I_6I_5I_4} میں \عددی{0001} ہو گا، جو  پتہ پختہ حافظہ کو  فراہم  ہو گا؛ پختہ حافظہ \عددی{0110} دیگا۔
...
\برآمد{} ہدایت میں پہلا فارغ خرد ہدایت \عددی{T_5} حال میں پایا جاتا ہے۔ یوں \عددی{T_5} حال کے آغاز میں  قابو پختہ حافظہ \عددی{3E3H} دیگا جس کو ضرب متمم گیٹ پہچان کر پست  \عددی{\overline{\text{\RL{فارغ}}}} پیدا کر  کے چھلا گنت کار کو \عددی{T_1} حال اختیار کرنے پر مجبور کرتا ہے۔ یوں، \برآمد{} ہدایت  چھ حال سے گھٹ کر چار حال کا ہو گا۔
