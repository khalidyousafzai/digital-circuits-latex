...
\ADD{9H}
\end{align*} 
پر عمل کرنے کے لئے درج ذیل اقدام پر عمل کرنا ہو گا۔ پہلے قدم پر،  دفتر  \دفترب میں \عددی{R_9} ڈالا جائے گا:
\begin{align*}
\regB=0000\,0011
\end{align*}
...
\جزوحصہء{\منفی{}}
دو اعداد منفی کرنے کے لئے کمپیوٹر کی ہدایت \اصطلاح{\منفی{}} ہے جو دفتر \دفترالف میں موجود عدد سے  دیا گیا عدد منفی کر کے نتیجہ دفتر \دفترالف میں ڈالے  گی۔ مکمل ہدایت میں منفی ہونے والے عدد کے مقام کا پتہ بھی شامل ہو گا۔
\begin{align*}
\SUB{پتہ}
\end{align*}
...
کمپیوٹر   حافظہ میں ہدایات اور مواد بھرنے کے لئے ہمیں ایسی زبان استعمال کرنی ہو گی جو کمپیوٹر  سمجھ سکے۔ جدول \حوالہ{جدول_کمپیوٹر_رموز}  میں  کمپیوٹر  کے \اصطلاح{ہدایتی رموز }\فرہنگ{ہدایتی رمز}\حاشیہب{operation codes, opcodes}\فرہنگ{opcode}    پیش ہیں۔ یوں \قول{ \نقل{}  } کی ہدایت کے لئے کمپیوٹر \عددی{0000} کا  ثنائی رمز استعمال کرتا ہے۔\قول{ \جمع{} } کے لئے \عددی{0001}، \قول{ \منفی{}} کے لئے \عددی{0010}، \قول{  \برآمد{}}کے لئے \عددی{1110}، اور \قول{ \رک} کے لئے \عددی{1111} رمز  استعمال ہو گا۔ 
\begin{table}
...
\حصہ{تعمیلی پھیرا}
اگلے تین حال ( \عددی{T_4}، \عددی{T_5}، اور \عددی{T_6} ) کمپیوٹر کا\اصطلاح{ تعمیلی پھیرا  }\فرہنگ{پھیرا!تعمیلی}\حاشیہب{execution cycle}\فرہنگ{cycle!execution}کہلاتے   ہیں۔تعمیلی پھیرا  کے دوران دفاتر میں معلومات کا انتقال  اس ہدایت پر منحصر ہے جس کی تعمیل کی جا رہی ہو۔ مثلاً،  \قول{\نقل{9H}}  کی تعمیل کے دوران دفاتر میں معلومات کا انتقال \قول{\جمع{BH}}  کی تعمیل کے دوران دفاتر میں معلومات کے انتقال  سے مختلف ہو گا۔آئیں     اب مختلف ہدایات  کی تعمیل  کے لئے\قول{ قابو  طریقہ کار } پر غور کریں۔

\جزوحصہء{معمولہ  \نقل{}}
اس گفتگو کو آگے بڑھانے کے لئے فرض کریں دفتر ہدایت میں \نقل{9H} بھرا گیا ہے۔
\begin{align*}
...
\end{align*}
قابو و ترتیب کار کو رمز کشائی کے لئے  جزو ہدایت  بھیجا جاتا ہے۔ رمز کشائی کے بعد   قابو و ترتیب کار   خارجی دفتر میں دفتر \دفترالف کا مواد منتقل کرنے کے لئے قابو لفظ جاری کرتا ہے۔
...
\جزوحصہء{\رک}
\رک کی ہدایت  پر عمل در آمد  کے دوران کسی دفتر کی ضرورت پیش نہیں آتی، لہٰذا  اس کے لئے معمولہ  قابو  درکار نہیں ہو گا۔ جب دفتر ہدایت میں درج ذیل موجود ہو
\begin{align*}
...
ایک ہدایت کی بازیابی اور تعمیل کے لئے درکار \عددی{T} حال کو \اصطلاح{ ہدایتی پھیرا }\فرہنگ{پھیرا!ہدایتی}\حاشیہب{instruction cycle}\فرہنگ{cycle!instruction}کہتے ہیں۔  کمپیوٹر  الف میں ہدایتی پھیرا اور مشینی پھیرا ایک  برابر ہیں، جبکہ  شکل \حوالہ{شکل_کمپیوٹر_مشینی_پھیرے}-ب میں ہدایتی پھیرا دو مشینی پھیروں کے برابر ہے۔
...
جدول \حوالہ{جدول_کمپیوٹر_خرد_برنامہ} میں  کمپیوٹر  الف کا خرد برنامہ پیش ہے، جس میں ہر کلاں ہدایت اور  اس کی تعمیل کے لئے درکار خرد ہدایات  دیے گئے ہیں۔ یہ  جدول  کمپیوٹر  الف کے معمولہ تعمیل   کا خلاصہ ہے۔ زیادہ جدید ہدایات کے لئے بھی ایسا جدول لکھا جا سکتا ہے۔
...
کسی بھی معمولہ تک رسائی کے لئے  درست پتہ  مہیا کرنا ہو گا۔مثلاً، \جمع{} معمولہ   کے لئے ہمیں \عددی{6H}، \عددی{7H}، اور \عددی{8H} پتے فراہم کرنا ہو گا۔ \برآمد{} معمولہ چلانے کے لئے \عددی{CH}، \عددی{DH}، اور \عددی{EH} پتے فراہم کرنا ہو گا۔ یوں کسی بھی معمولہ تک رسائی درج ذیل تین اقدام پر چلتے ہوئے ممکن ہو گی۔
\begin{enumerate}[1.]
\item
...
\اصطلاح{ متغیر مشینی پھیرا }\فرہنگ{مشینی  پھیرا!متغیر}\حاشیہب{variable machine cycle}\فرہنگ{machine cycle!variable} حاصل کرنے کا ایک طریقہ شکل \حوالہء{10۔17}  میں  پیش ہے۔  \نقل{} ہدایت کے لئے \عددی{T_1} تا \عددی{T_5} حال  ہو بہو مقررہ مشینی پھیرا کی طرح ہیں۔  \عددی{T_6} حال  کے آغاز  میں  قابو پختہ حافظہ \عددی{3E3H} (یعنی فارغ خرد ہدایت)  پیدا کرے گا۔ ضرب متمم گیٹ اس ہدایت کو فوراً پہچان کر  پست \عددی{\overline{\text{\RL{فارغ}}}}  خارج کرتا ہے۔ جیسا شکل \حوالہء{10۔18} میں دکھایا گیا ہے،  ضرب گیٹ کی مدد سے  \عددی{\overline{\text{\RL{فارغ}}}} چھلا گنت کار کو مہیا کیا گیا ہے۔ چھلا گنت کار فوراً \عددی{T_1} حال  اختیار کر کے  نئے مشینی پھیرے کا آغاز کرتا ہے۔ یوں \نقل{} ہدایت چھ   سے  گھٹ کر پانچ حال   کا ہو گا۔
...
5+4-6
\end{align*}
مواد کے لئے \عددی{DH}، \عددی{EH}، اور \عددی{FH} پتے استعمال کریں۔
...
\end{center}
 ...
 درج ذیل حل کرنے کے لئے  کمپیوٹر کی مادری زبان میں برنامہ لکھیں۔ مواد کے لئے \عددی{BH} تا \عددی{FH} پتے استعمال کریں۔
 \begin{align*}
 8+4-3+5-2
 \end{align*}
...
\end{center}
 ...
 %Q6
 \ابتدا{سوال}
 فرض کریں \عددی{8085} کی ساعت کا تعدد \عددی{\SI{3}{\mega\hertz}} ہے۔  \جمع{} ہدایت  کی بازیابی اور تعمیل کے لئے  چار \عددی{T} حال    درکار ہیں۔یہ کتنا وقت ہے؟
 \انتہا{سوال}
 %----------------------
 %Q7
 \ابتدا{سوال}
  کمپیوٹر   الف کے \نقل{} معمولہ کی خرد ہدایات کیا ہیں؟ \منفی{} معمولہ کے لئے کیا ہیں؟ جواب ثنائی اور سادس عشری روپ  میں پیش کریں۔ 
 
 جواب:
\قول{ \نقل{} } کے لئے  \عددی{1A3H}، \عددی{2C3H}، \عددی{3E3H}  یا \عددی{000110100011}، \عددی{001011000011}، \عددی{001111100011}؛
\منفی{} کے لئے \عددی{1A3H}، \عددی{2E1H}، \عددی{3CFH} یا \عددی{000110100011}، \عددی{001011100001}،\عددی{001111001111}؛
 \انتہا{سوال}
 %---------------------
 %Q8
 \ابتدا{سوال}
...
دفتر \دفترالف کا مواد  \عددی{\overline{CLK}} کے کنارہ چڑھائی پر کہ کنارہ اترائی پر تبدیل ہو گا؟
 ...
 \item
 برنامہ گنت کار کو بڑھانے کے لئے \عددی{C_P} بلند ہو گا یا پست؟
 \item
 برنامہ گنت کار صاف کرنے کے لئے \عددی{\overline{CLR}} بلند ہو گا یا پست؟
 \item
 برنامہ گنت کار کا مواد \عددی{W} گزرگاہ  پر  رکھنے کے لئے \عددی{E_P} بلند ہو گا یا پست؟
 \end{enumerate}
 ...
 \ابتدا{سوال}
  ...
  \item
  \عددی{u29} کے پنیا \عددی{3} پر ساعت  کا اشارہ موجود ہونے کے لئے \عددی{\overline{HLT}} بلند یا پست ہونا ہو گا؟
  \end{enumerate}
