...
\draw(\ksepX,-0*\ksepY)  [thick] rectangle ++(\kdimX,\kdimY)node[pos=0.5,rectangle,inner sep=0pt,text width=1cm,align=center]{\RTL{دفتر\\    \دفترالف}};
...
\draw(\ksepX,-2*\ksepY)  [thick] rectangle ++(\kdimX,\kdimY)node[pos=0.5,rectangle,inner sep=0pt,text width=1cm,align=center]{\RTL{دفتر\\  \regB}};
...
\end{tikzpicture}
\caption{ کمپیوٹر الف  کی بناوٹ}
\label{شکل_کمپیوٹر_سادہ_ترین}
\end{figure}

کمپیوٹر  الف کے مختلف حصے واضح کرنے کی غرض سے شکل \حوالہ{شکل_کمپیوٹر_سادہ_ترین}  بنایا گیا ہے۔ اسی لیے تمام    قابو اشارات  ایک  خانہ (ڈبہ)  جسے \اصطلاح{ قابو مرکز }\فرہنگ{قابو مرکز}\حاشیہب{control unit}\فرہنگ{control unit}کہتے ہیں میں رکھے گئے ہیں ؛ تمام داخلی  اور خارجی ادوار ایک  خانہ جسے\اصطلاح{ دخول و خروج مرکز }\فرہنگ{دخول و خروج مرکز}\حاشیہب{input-output unit}\فرہنگ{input output unit} کہتے ہیں میں  رکھے گئے ہیں، وغیرہ، وغیرہ۔

شکل \حوالہ{شکل_کمپیوٹر_سادہ_ترین} میں پیش کئی دفاتر  آپ پہلے سے  جانتے ہیں۔  ہر ڈبے کی   خصوصیات مختصراً  بیان کرتے ہیں؛ ان پر تفصیلی گفتگو بعد میں کی جائے گی۔
...
گویا ہدایت گنت کار اس شخص کی طرح ہے جو ہدایت کی فہرست  کی طرف اشارہ کرتے ہوئے کہتا ہے یہ کام  پہلے کریں، یہ کام دوسرے نمبر پر کریں، یہ تیسرے نمبر پر کریں، وغیرہ۔ اسی لیے ہدایت گنت کار بعض اوقات \اصطلاح{  اشارہ گر   }\فرہنگ{اشارہ گر}\حاشیہب{pointer}\فرہنگ{pointer} کہلاتا ہے؛ یہ حافظہ میں اس مقام کی طرف اشارہ کرتا ہے جہاں کوئی   اہم معلومات درج ہو گی۔

\جزوحصہء{برنامہ نویس   اور  دفتر پتہ}
ہدایت گنت کار کے نیچے برنامہ نویس   اور دفتر پتہ کا  خانہ  ہے۔ شکل \حوالہ{شکل_کمپیوٹر_برنامہ_نویسی} میں برنامہ نویس پیش ہے (     صفحہ \حوالہصفحہ{شکل_حافظہ_میں_مواد_کی_لکھائی} پر شکل \حوالہ{شکل_حافظہ_میں_مواد_کی_لکھائی} سمجھیں)   جس  کے ذریعہ سوئچوں  کی مدد سے   عارضی حافظہ کو  \عددی{4} پتہ اور \عددی{8} مواد   بِٹ فراہم کر  کے بھرا جاتا ہے۔ یاد رہے کمپیوٹر کی  (با مقصد)دوڑ سے قبل عارضی حافظہ میں برنامہ  لکھنا لازمی ہے۔

  \قول{دفتر پتہ    } کمپیوٹر  الف کے عارضی حافظے کا حصہ ہے۔ کمپیوٹر  کی دوڑ کے دوران، ہدایت گنت کار  میں موجود پتہ  اس   (دفتر پتہ)     میں  نقل  کیا جاتا ہے۔  دفتر پتہ   چند لمحوں بعد یہ پتہ عارضی  حافظہ کو فراہم کرتا ہے، جہاں سے   اگلی ہدایت پڑھی (اٹھائی)  جاتی ہے۔
...
\draw[thick](0,0)rectangle++(\kxdim,\kydim)node[pos=0.6,below]{$74LS219$}node[pos=0.6,above]{\text{\RL{حافظہ}}};
...
\draw[thick](\ksepX,0*\ksepY)rectangle++(\kxdim,\kydim)node[pos=0.6,below]{$74LS219$}node[pos=0.6,above]{\text{\RL{حافظہ}}};
...
\جزوحصہء{دفتر ہدایت}
 قابو مرکز کا ایک حصہ  \اصطلاح{دفتر ہدایت  }\فرہنگ{دفتر ہدایت}\حاشیہب{instruction register}\فرہنگ{instruction register} ہے۔حافظہ سے ہدایت پڑھنے کی خاطر کمپیوٹر   جو عمل  سرانجام دیتا ہے اس کو \اصطلاح{ہدایت پڑھ عمل }\فرہنگ{ہدایت پڑھ عمل}\حاشیہب{memory read operation}\فرہنگ{operation!memory read} کہتے ہیں۔  حافظہ کے    \اصطلاح{مخاطب  مقام   }\فرہنگ{مخاطب مقام}\حاشیہب{addressed location}\فرہنگ{addressed location} پر موجود ہدایت (یا مواد) کو  یہ عمل \عددی{W} گزرگاہ پر رکھتا ہے۔ ساتھ ہی   ساعت کے اگلے مثبت کنارے پر  دفتر  ہدایت بھرائی کے لیے تیار کر دیا جاتا ہے۔ ( مخاطب مقام سے مراد حافظہ میں وہ مقام ہے جس کا پتہ حافظہ کو فراہم کیا گیا ہو۔)
 
 دفتر ہدایت    میں موجود معلومات کو دو حصوں میں تقسیم کیا جاتا ہے۔  زیریں (نچلے) چار بِٹ سہ حالی مخارج ہے  جو بوقت ضرورت \عددی{W} گزرگاہ پر ڈال دیا جاتا ہے جبکہ   بالا چار بِٹ  دو حالی مخارج ہے جو سیدھا  قابو و ترتیب کار  کو مہیا کیا جاتا ہے۔
 
 \جزوحصہء{قابو و ترتیب کار}
 کمپیوٹر کی ہر دوڑ سے قبل  ہدایت گنت کار کو پست (فعال) \عددی{\overline{CLR}} اور دفتر   ہدایت کو  بلند (فعال)\عددی{CLR}  اشارہ بھیجا جاتا ہے ، جو ہدایت گنت کار صاف    \عددی{(0000)}     کرتا ہے اور دفتر ہدایت   میں موجود ہدایت  زائل  کرتا  ہے۔

تمام مستحکم کار دفاتر کو ساعتی اشارہ \عددی{CLK} بھیجا جاتا ہے جو کمپیوٹر کے  مختلف اعمال   ہم قدم    کرتے ہوئے اس بات کو  یقینی بناتا ہے کہ تمام کام  اپنے اپنے  وقت پر  ہو۔ دوسرے لفظوں میں،   دفاتر کے مابین معلومات کا تبادلہ مشترک ساعت \عددی{CLK} کے مثبت کنارے پر ہو گا۔ دھیان رہے، ہدایت گنت کار کو \عددی{\overline{CLK}} اشارہ بھی فراہم کیا گیا ہے۔

قابو و ترتیب کار \عددی{12} بِٹ\اصطلاح{   قابو لفظ }\فرہنگ{قابو لفظ}\حاشیہب{control word}\فرہنگ{control word} خارج کرتا ہے جو باقی کمپیوٹر کو قابو کرتا ہے۔ وہ \عددی{12} برقی تار جن  پر یہ لفظ ترسیل ہوتا ہے \اصطلاح{ قابو گزرگاہ }\فرہنگ{گزرگاہ!قابو}\حاشیہب{control bus}\فرہنگ{bus!control} کہلاتا ہے۔

بارہ بِٹ  \قول{قابو  لفظ   } درج ذیل ہے۔
\begin{align*}
...
\end{align*}
 ...
 ساعت \عددی{CLK} کے  اگلے   مثبت کنارے پر  دفاتر کا عمل اس لفظ کے تحت ہو گا۔ مثلاً، بلند \عددی{E_P} اور پست \عددی{\overline{L}_M} کی صورت میں ساعت کے اگلے مثبت کنارے پر ہدایت گنت کار کی معلومات   دفتر پتہ میں نقل ہو گی۔ اسی طرح، پست \عددی{\overline{CE}} اور پست \عددی{\overline{L}_A} کی صورت میں  ساعت کے اگلے مثبت کنارے پر  دفتر \دفترالف   میں عارضی حافظہ کا مخاطب   لفظ نقل ہو گا۔انتقال    مواد  کی وقتیہ  ترسیمات پر غور  ( جس سے ہم جان پائیں گے   یہ انتقال  کیسے اور کب ہو ں گے) بعد میں کیا جائے گا ۔

\جزوحصہء{دفتر \دفترالف}
 کمپیوٹر کی دوڑ کے دوران   حاصل نتائج دفتر \دفترالف میں ذخیرہ کیے جاتے ہیں۔ شکل \حوالہ{شکل_کمپیوٹر_سادہ_ترین} میں \دفترالف کے دو مخارج  دکھائے گئے ہیں۔اس کا دو حالی مخارج   سیدھا جمع و منفی کار کو جاتا ہے جبکہ تین حالی مخارج \عددی{W} گزرگاہ کو جاتا ہے۔ یوں \دفترالف کا آٹھ بِٹ لفظ  جمع و منفی کار کو    مسلسل فراہم ہو گا؛ یہی لفظ  بلند \عددی{E_A} کی صورت میں \عددی{W} گزرگاہ  پر بھی ڈالا جائے گا۔
 
 \جزوحصہء{جمع و منفی کار}
 یہاں  تکملہ  \عددی{2} کا   جمع و منفی کار مستعمل ہے۔ پست \عددی{S_U}  کی صورت میں شکل \حوالہ{شکل_کمپیوٹر_سادہ_ترین} میں جمع و منفی کار کا مخارج \عددی{S}  درج ذیل ہو گا۔
 \begin{align*}
 S=\regB+\regA
 \end{align*}
 بلند \عددی{S_U} کی صورت میں  جمع و منفی کار درج ذیل دے گا جہاں \عددی{B'} سے مراد \عددی{B} کا  اساس \عددی{2} تکملہ ہے۔(یاد رہے، \عددی{2} کا تکملہ علامت تبدیل کرنے کے مترادف ہے۔)
  \begin{align*}
 S=\regB'+\regA
 \end{align*}
...
\جزوحصہء{دفتر \دفترب}
دفتر \دفترب حسابی   اعمال میں  استعمال کیا جاتا ہے۔ پست \عددی{\overline{L}_B} کی صورت میں ساعت کے مثبت کنارے  پر \عددی{W} گزرگاہ پر موجود لفظ \دفترب میں نقل ہو گا۔ دفتر \دفترب کا دو حالی مخارج مسلسل جمع و منفی کار کو فراہم کیا جاتا ہے ۔ یہ عدد \دفترالف میں موجود عدد کے ساتھ جمع یا اس سے منفی ہو گا۔

\جزوحصہء{خارجی دفتر}
کسی بھی مسئلے کو حل کرنے کے بعد حاصل نتیجہ دفتر \دفترالف میں     ہو گا۔ یہ نتیجہ بیرونی دنیا کو بتانا مقصود ہو گا۔یہ کام \اصطلاح{ خارجی دفتر }\فرہنگ{خارجی دفتر}\حاشیہب{output register}\فرہنگ{register!output} کے سپرد ہے۔ بلند \عددی{E_A} اور پست \عددی{\overline{L}_O} کی صورت میں ساعت کے  اگلے  مثبت کنارے پر \دفترالف میں موجود معلومات خارجی دفتر میں نقل کی جاتی ہے۔
...
\جزوحصہء{خلاصہ}
اس کمپیوٹر کا قابو مرکز ہدایت گنت کار، ہدایت دفتر، اور قابو و ترتیب کار  (جو قابو لفظ، ساعت \عددی{CLK}، اور زائل  اشارہ \عددی{CLR}  پیدا کرتا ہے) پر مشتمل ہے۔ کمپیوٹر کا\اصطلاح{ مرکز حساب و منطق }\فرہنگ{مرکز حساب و منطق}\حاشیہب{arithmetic logic unit, ALU}\فرہنگ{ALU}  دفتر \دفترالف، دفتر \دفترب، اور جمع و منفی کار پر مشتمل ہے۔کمپیوٹر کا حافظہ  دفتر پتہ اور \عددی{16\times 8} عارضی حافظہ پر مشتمل ہے۔  درآمدی  سوئچ، خارجی روزن، اور ثنائی نمائشی تختی  مل کر   دخول و خروج مرکز دیتے ہیں۔

\حصہ{ہدایات کی فہرست} 
کمپیوٹر کی با مقصد دوڑ سے قبل اس کے حافظہ  میں ہدایات قدم بہ قدم  بھرنا لازم ہے۔البتہ، ایسا کرنے سے پہلے  آپ کو یہ ہدایات  جاننی  ہو گی۔ان ہدایات سے مراد وہ اعمال ہیں جو یہ کمپیوٹر سرانجام دے سکتا ہے۔ اس کمپیوٹر کی ہدایات کی فہرست  پر اب غور کرتے ہیں۔ہدایات کا مجموعہ کمپیوٹر کی \اصطلاح{ مادری زبان }\فرہنگ{زبان!مادری}\فرہنگ{مادری زبان}\حاشیہب{ assembly language}\فرہنگ{language!assembly}\فرہنگ{assembly language} کہلاتا ہے۔

\جزوحصہء{\نقل{}}
حافظہ کے مقام \عددی{0000_2} پر موجود معلومات کو ہم  \عددی{R_0} کہتے ہیں، مقام \عددی{0001_2} پر  \عددی{R_1} ہو گا، وغیرہ ۔ یوں \عددی{R_0} مقام \عددی{0H} پر محفوظ ہے ، \عددی{R_1} پتہ \عددی{1H} پر، \عددی{R_2} پتہ \عددی{2H} پر، وغیرہ، جہاں \عددی{0H} سے مراد   \عددی{0_{16}} ہے۔سادس عشری  اعداد کے آخر میں  زیرنوشت \عددی{16} لکھنے کے بجائے ہم عدد کے آخر میں \عددی{H} لکھتے ہیں۔

کمپیوٹر الف کی ایک ہدایت \موٹا{\نقل{}}   ہے ، جو  دفتر ا  الف میں مواد\قول{ نقل }کرنے کی ہدایت ہے۔ پوری ہدایت میں    اس مواد کا  سادس عشری پتہ بھی دیا جاتا ہے جو دفتر \دفترالف میں بھرا جائے گا، لہٰذا مکمل ہدایت درج ذیل ہے،  جو جدول \حوالہ{جدول_کمپیوٹر_ہدایات} میں   بھی پیش ہے۔
\begin{align*}
\LDA{پتہ}
\end{align*}
 یوں\قول{\نقل{8H}} کہتی ہے ، عارضی حافظہ کے پتہ \عددی{8H} پر درج معلومات کو دفتر \دفترالف میں نقل کر؛ یعنی حافظہ کے مقام \عددی{8H} سے دفتر \دفترالف میں مواد ڈال۔ اس ہدایت پر عمل کرنے کے بعد دفتر \دفترالف میں  اور حافظہ کے مقام  \عددی{8H} پر ایک سا مواد  پایا جائے گا۔ یوں  درج ذیل صورت میں
\begin{align*}
R_8=1111\,0000
\end{align*}
...
\regA=1111\,0000
\end{align*}
آپ نے دیکھا  یہ  ہدایت دفتر \دفترالف میں معلومات نقل کرتے ہوئے  حافظہ میں درج معلومات پر   اثر انداز نہیں ہوتی۔

اسی طرح \قول{\نقل{AH}}، حافظہ کے   مقام \عددی{10_{10}} سے دفتر \دفترالف میں معلومات  نقل کرے گی، اور \قول{\نقل{FH}} حافظہ کے  مقام \عددی{F_{16}} سے معلومات دفتر \دفترالف میں نقل کرے گی۔

\جزوحصہء{\ADD{}}
کمپیوٹر کی یہ ہدایت دو اعداد \قول{ جمع } کرنے کو کہتی  ہے۔پہلا عدد دفتر \دفترالف میں ہو گا جبکہ دوسرے عدد کا پتہ مکمل ہدایت میں شامل ہو گا؛ نتیجہ دفتر \دفترالف میں محفوظ ہو گا، لہٰذا دفتر \دفترالف میں پہلے سے موجود مواد زائل ہو گا۔یوں   اگر دفتر \دفترالف میں \عددی{2_{10}} اور حافظہ کے مقام \عددی{9H} پر \عددی{3_{10}} ہو:
\begin{align*}
\regA&=0000\,0010\\
R_9&=0000\,0011
\end{align*}
...
\ADD{9H}
\end{align*} 
پر عمل کرنے کے لیے درج ذیل اقدام پر عمل کرنا ہو گا۔ پہلے قدم پر،  دفتر  \دفترب میں \عددی{R_9} ڈالا جائے گا:
\begin{align*}
\regB=0000\,0011
\end{align*}
...
\end{align*}
معلوم  کرتا ہے۔دوسرے قدم پر،   یہ مجموعہ دفتر \دفترالف میں ڈالا جاتا ہے۔
\begin{align*}
\regA=0000\,0101
\end{align*}

جب  بھی \قول{\جمع{}}  کی ہدایت پر عمل کیا جائے درج بالا اقدام اٹھانے ہوں گے؛ دیے گئے پتہ سے مواد دفتر  \دفترب  میں ڈال کر جمع  و منفی کار  سے مجموعہ حاصل کرنے کے بعد نتیجہ دفتر \دفترالف میں ڈالا جاتا ہے۔چونکہ   دفتر \دفترالف میں پہلے سے موجود مواد  کے اوپر  نیا مواد (حاصل جمع) لکھا جاتا ہے لہٰذا  دفتر \دفترالف کا پرانا  مواد زائل ہو گا۔اسی طرح چونکہ دفتر  \دفترب میں دیے گئے پتے کا مواد ڈالا  کیا جاتا ہے لہٰذا دفتر  \دفترب  کا پرانا مواد بھی زائل ہو گا۔ اس طرح  \قول{\جمع{9H}} پر عمل کرنے سے دفتر \دفترالف کا مواد اور \عددی{R_9} کا مجموعہ دفتر \دفترالف میں  حاصل ہو گا۔ \قول{\جمع{FH}} پر عمل کے بعد دفتر \دفترالف میں \عددی{R_F} اور دفتر \دفترالف کا مجموعہ پایا جائے گا۔
...
\midrule
\نقل{پتہ}& دفتر \دفترالف میں حافظہ سے مواد کا  نقل\\
\جمع{پتہ}& دفتر \دفترالف کے ساتھ حافظہ کا مواد جمع  کرنا\\
\منفی{پتہ}&دفتر \دفترالف سے حافظہ کا مواد منفی کرنا\\
\برآمد{}&دفتر \دفترالف کا مواد  ر خارجی  دفتر میں ڈالنا\\
\رک& کام  روک دینا\\
\bottomrule
\end{tabular}
\end{table}
...
\جزوحصہء{\منفی{}}
دو اعداد منفی کرنے کے لیے کمپیوٹر کی ہدایت \اصطلاح{\منفی{}} ہے جو دفتر \دفترالف میں موجود عدد سے  دیا گیا عدد منفی کر کے نتیجہ دفتر \دفترالف میں ڈالے  گی۔ مکمل ہدایت میں منفی ہونے والے عدد کے مقام کا پتہ بھی شامل ہو گا۔
\begin{align*}
\SUB{پتہ}
\end{align*}
یوں \قول{\منفی{CH}} کا مطلب ہے دفتر \دفترالف میں موجود مواد سے حافظہ  کے مقام \عددی{CH} پر موجود مواد \عددی{R_C} منفی کر کے نتیجہ دفتر \دفترالف میں ڈالیں۔

مثال کی خاطر فرض کریں دفتر \دفترالف میں  اعشاری \عددی{7} اور  حافظہ کے مقام \عددی{CH} پر اعشاری \عددی{3} پایا جاتا ہے۔
\begin{align*}
\regA&=0000\,0111\\
R_C&=0000\,0011
\end{align*}
\قول{\منفی{CH}} پر عمل درج ذیل اقدام اٹھانے سے ہو گا۔ پہلے قدم پر،  دفتر \دفترب  میں \عددی{R_C}  ڈالا  کیا جاتا ہے: 
\begin{align*}
\regB=0000\,0011
\end{align*}
جس کے فوراً بعد جمع و منفی کار دفتر \دفترالف اور ب کا فرق:
\begin{align*}
\text{فرق}=0000\,0100
\end{align*}
  معلوم کرتا ہے۔دوسرے قدم پر یہ فرق  دفتر \دفترالف میں  ڈالا جاتا ہے۔
\begin{align*}
\regA=0000\,0100
\end{align*}

\منفی{} ہدایت  پر عمل درج بالا اقدام کے ذریعہ ہو گا؛ دیے گئے پتہ پر موجود مواد حافظہ سے دفتر \دفترب  میں ڈال کر جمع و منفی کار کو مہیا کیا جاتا ہے جو فوراً ان کا فرق معلوم کرتا ہے۔ یہ فرق دفتر \دفترالف میں ڈالا جاتا ہے۔ یوں \قول{\منفی{CH}} پر عمل کرتے ہوئے \عددی{R_C} کو دفتر \دفترالف سے منفی کر کے نتیجہ دفتر \دفترالف میں ڈالا جائے گا۔ \قول{\منفی{EH}} مقام \عددی{EH}  پر موجود مواد \عددی{R_E} کو دفتر \دفترالف سے منفی کر کے نتیجہ دفتر \دفترالف میں ڈالتا ہے۔

\جزوحصہء{\برآمد{}}
کمپیوٹر کی ہدایت  \اصطلاح{\برآمد{}}  کہتی ہے دفتر \دفترالف کا مواد خارجی دفتر میں ڈالیں۔اس ہدایت پر عمل کرنے کے بعد دفتر \دفترالف کا مواد کمپیوٹر سے باہر دستیاب ہو گا جہاں سے آپ نتیجہ دیکھ سکتے ہیں۔

اس ہدایت پر عمل کرنے کے لیے  حافظہ سے رجوع کرنے کی ضرورت نہیں لہٰذا اس ہدایت میں پتہ درکار نہیں ہے۔
...
\جزوحصہء{حافظہ سے رجوع کرنے والی   راجع  ہدایات}
\نقل{}، \جمع{} ، اور \منفی{}  ہدایات حافظہ سے رجوع کرتی  ہیں لہٰذا یہ\اصطلاح{  راجع ہدایات }\فرہنگ{راجع ہدایات}\حاشیہب{memory-reference instructions}\فرہنگ{memory reference instructions} کہلاتی ہیں۔ اس کے برعکس  \برآمد{} اور   \رک  حافظہ سے رجوع نہیں کرتی ہیں لہٰذا یہ ہدایات غیر راجع  ہیں۔

\جزوحصہء{\عددی{8080} اور \عددی{8085}}
وسیع  پیمانے پر استعمال ہونے والا  پہلا \اصطلاح{   خرد عامل  کار  }\فرہنگ{خرد عامل کار}\حاشیہب{microprocessor}\فرہنگ{microprocessor} (مائکروپراسیسر ) \عددی{8080}  تھا۔ اس کی کُل \عددی{72} ہدایات ہیں۔اس خرد عامل کار \عددی{8085} ہے  جو انہیں ہدایات پر چلتا ہے۔   کمپیوٹر  الف کو حقیقتاً قابل استعمال بنانے کی غرض سے ہم  اس کی ہدایات کو  \عددی{8080\! / \! 8085}  کی ہدایت کے  ہم آہنگ بناتے ہیں۔ دوسرے لفظوں میں  \نقل{}، \جمع{}، \منفی{}، \برآمد{}، اور \رک  \عددی{8080\! / \! 8085}  کی بھی ہدایات ہیں۔
...
حل:\quad
برنامہ نچلے حافظہ میں \عددی{0H} تا \عددی{5H} مقامات پر رکھا گیا ہے۔ پہلی ہدایت حافظہ کے مقام \عددی{9H} سے مواد \عددی{01H} دفتر \دفترالف میں نقل کرتی ہے۔
\begin{align*}
\regA=01H
\end{align*}
دوسری ہدایت مقام \عددی{AH}  کا مواد دفتر \دفترالف کے ساتھ جمع کر کے نتیجہ دفتر \دفترالف میں ڈالتی ہے۔
\begin{align*}
\regA=01H+02H=03H
\end{align*}
تیسری ہدایت حافظہ کے مقام \عددی{BH} کے مواد کو دفتر \دفترالف (جس میں اس وقت \عددی{03H} موجود ہے) کے ساتھ جمع کر کے نتیجہ دفتر \دفترالف منتقل کرتی ہے۔
\begin{align*}
\regA=03H+03H=06H
\end{align*}
چوتھی ہدایت مقام \عددی{CH} کے مواد کو دفتر \دفترالف سے منفی کرکے نتیجہ دفتر \دفترالف میں ڈالتی ہے۔
\begin{align*}
\regA=06H-04H=02H
\end{align*}
پانچویں ہدایت دفتر \دفترالف کے مواد کو خارجی دفتر میں منتقل کرتی ہے۔خارجی دفتر کے ساتھ ثنائی نمائشی تختی   منسلک ہے جس پر یہ مواد ثنائی روپ میں نظر آئے گا۔یوں  نوری ڈایوڈ درج ذیل دکھائیں گے۔
\begin{align*}
0000\,0010
\end{align*}
...
کمپیوٹر   حافظہ میں ہدایات اور مواد بھرنے کے لیے ہمیں ایسی زبان استعمال کرنی ہو گی جو کمپیوٹر  سمجھ سکے۔ جدول \حوالہ{جدول_کمپیوٹر_رموز}  میں  کمپیوٹر  کے \اصطلاح{ہدایتی رموز }\فرہنگ{ہدایتی رمز}\حاشیہب{operation codes, opcodes}\فرہنگ{opcode}    پیش ہیں۔ یوں \قول{ \نقل{}  } کی ہدایت کے لیے کمپیوٹر \عددی{0000} کا  ثنائی رمز استعمال کرتا ہے۔\قول{ \جمع{} } کے لیے \عددی{0001}، \قول{ \منفی{}} کے لیے \عددی{0010}، \قول{  \برآمد{}}کے لیے \عددی{1110}، اور \قول{ \رک} کے لیے \عددی{1111} رمز  استعمال ہو گا۔ 
\begin{table}
...
\انتہا{مثال}
\ابتدا{مثال}
درج  ذیل  حساب کرنے کے لیے کمپیوٹر کا برنامہ  لکھیں۔ تمام اعداد اعشاری ہیں۔
\begin{align*}
16+20+24-32
\end{align*}

حل:\quad
گزشتہ مثال کا برنامہ لے کر  حافظہ کے مقام \عددی{9H} تا \عددی{CH} میں بالترتیب  مواد \عددی{16}، \عددی{20}، \عددی{24}، اور \عددی{32}  کے  سادس عشری مماثل لکھ کر    درج ذیل مطلوبہ برنامہ حاصل ہو گا۔(اعشاری \عددی{16} کا  سادس عشری مماثل \عددی{10H} ہے۔)
\begin{center}
\begin{tabular}{rr}
\multicolumn{1}{c}{\text{\RL{پتہ}}}& \multicolumn{1}{c}{\text{\RL{ہدایت}}}\\[0.5ex]
0H& \LDA{9H}\\
...
\انتہا{مثال}
\ابتدا{مثال}
درج بالا مثال میں حاصل ثنائی برنامہ کو  سادس عشری  روپ میں لکھیں۔ ثنائی روپ کے بجائے ہم عموماً  برنامے کا  سادس عشری روپ استعمال کرتے ہیں۔
...
سادس عشری  میں لکھی گئی زبان بھی مشینی زبان کہلاتی ہے۔
  ...
  مشینی زبان میں منفی عدد کا اساس \عددی{2} تکملہ  استعمال کیا جاتا ہے۔ مثال کے طور پر ، \عددی{-03H}  کے بجائے \عددی{FDH} حافظہ میں ڈالا جائے گا۔
\انتہا{مثال}
...
اس کمپیوٹر میں  چھلا گنت کار  مستعمل ہے جو شکل \حوالہ{شکل_کمپیوٹر_چھلا} میں پیش ہے۔ مخلوط دور \عددی{74107} میں دو عدد جے کے پلٹ کار  پائے جاتے ہیں لہٰذا تین مخلوط دور استعمال کیے گئے۔ اس  مخلوط دور میں زبردستی پست   کا مداخل موجود ہے، تاہم اس میں زبردستی بلند کا مداخل موجود نہیں۔  استعمال سے پہلا ایک مرتبہ  چھلا گنت کار کو ابتدائی حال میں لانا ضروری ہے جس میں صرف ایک مخارج بلند ہو۔  زبردستی پست مداخل پلٹ کے   مخارج پس کر تا ہے جبکہ ہمیں ایک مخارج بلند چاہیے۔ اسی لیے  بایاں ترین پلٹ باقی سے مختلف طریقے سے استعمال کیا گیا ہے۔ پست حال میں اس کا \عددی{\overline{Q}} بلند ہو گا جو ساعت کے کنارہ اترائی پر اگلی پلٹ کو منتقل ہو گا۔
...
شکل \حوالہ{شکل_کمپیوٹر_چھلا}  -ب میں   گنت کار کی  خانہ دار  شکل   جبکہ  شکل-د میں ساعت اور وقتیہ ترسیمات  پیش ہیں۔ چھلا گنت کار کا مخارج درج ذیل ہے۔
\begin{align*}
...
\draw(\ksepX,-0*\ksepY)  [thick] rectangle ++(\kdimX,\kdimY);%node[pos=0.5,rectangle,inner sep=0pt,text width=1cm,align=center]{\RTL{\دفترالف}};
\draw(\ksepX,-0*\ksepY+\kulV+0*\kpsep)--++(-\kpina,0); 
\draw(\ksepX,-0*\ksepY+\kulV+1*\kpsep)--++(-\kpina,0); 
\draw(\ksepX,-0*\ksepY+\kulV+0*\kpsep)++(-\kpina,0)++(0.5*\kpsep,-0.5*\kpsep)--++(-\kpsep,\kpsep)--++(\kpsep,\kpsep);
\draw(\ksepX,-0*\ksepY+\kulV+3*\kpsep)++(-0.5*\kpsep,0)--++(-\kpina,0); 
...
\draw(\ksepX,-2*\ksepY)  [thick] rectangle ++(\kdimX,\kdimY);%node[pos=0.5,rectangle,inner sep=0pt,text width=1cm,align=center]{\RTL{\regB}};
\draw(\ksepX,-2*\ksepY+\kulV+1.5*\kpsep)++(-0.5*\kpsep,0)--++(-\kpina,0); 
\draw(\ksepX,-2*\ksepY+\kulV+2.5*\kpsep)++(-0.5*\kpsep,0)--++(-\kpina,0); 
\draw(\ksepX,-2*\ksepY+\kulV+1.5*\kpsep)++(-1*\kpsep,-0.5*\kpsep)--++(\kpsep,\kpsep)--++(-\kpsep,\kpsep);
...
\حصہ{تعمیلی پھیرا}
اگلے تین حال ( \عددی{T_4}، \عددی{T_5}، اور \عددی{T_6} ) کمپیوٹر کا\اصطلاح{ تعمیلی پھیرا  }\فرہنگ{پھیرا!تعمیلی}\حاشیہب{execution cycle}\فرہنگ{cycle!execution}کہلاتے   ہیں۔تعمیلی پھیرا  کے دوران دفاتر میں معلومات کا انتقال  اس ہدایت پر منحصر ہے جس کی تعمیل کی جا رہی ہو۔ مثلاً،  \قول{\نقل{9H}}  کی تعمیل کے دوران دفاتر میں معلومات کا انتقال \قول{\جمع{BH}}  کی تعمیل کے دوران دفاتر میں معلومات کے انتقال  سے مختلف ہو گا۔آئیں     اب مختلف ہدایات  کی تعمیل  کے لیے\قول{ قابو  طریقہ کار } پر غور کریں۔
...
دوران \عددی{T_5} حال ، \عددی{\overline{CE}} اور \عددی{\overline{L}_A} پست ہوں گے۔ یوں ساعت کے اگلے کنارہ  چڑھائی پر  حافظہ کے مقام پتہ  سے  مواد  کا لفظ دفتر \دفترالف  میں نقل  ہو گا (شکل  \حوالہ{شکل_کمپیوٹر_اجاگر_حصے_تعمیلی_پھیرا}-ب  دیکھیں)۔

\عددی{T_6}\اصطلاح{ فارغ حال }\فرہنگ{حال!فارغ}\حاشیہب{nop, no operation}\فرہنگ{nop} ہے۔اس (تیسرے تعمیلی ) حال کے دوران تمام دفاتر غیر فعال ہیں (شکل  \حوالہ{شکل_کمپیوٹر_اجاگر_حصے_تعمیلی_پھیرا}-ج دیکھیں)۔ یوں قابو و ترتیب کار ایسا قابو لفظ خارج کرتا ہے جس کے تمام بِٹ غیر فعال ہوں گے۔  فارغ حال( بلا عمل حال) میں  کام سرانجام نہیں ہو گا۔
...
\draw(\ksepX,-0*\ksepY)  [thick] rectangle ++(\kdimX,\kdimY)node[pos=0.5,rectangle,inner sep=0pt,text width=1cm,align=center]{\RTL{دفتر}\\ \RTL{\دفترالف}};
\draw(\ksepX+\kdimX,-0*\ksepY+\kulV+4*\kpsep)--++(\kpin,0)node[right]{$\overline{L}_A$}; 
...
\end{subfigure}
\caption{
معمولہ \نقل{}: (ا) \عددی{T_4} حال؛ (ب) \عددی{T_5} حال؛ (ج) \عددی{T_6} حال۔
}
...
\عددی{T_5} حال کے دوران قابو بِٹ \عددی{\overline{CE}} اور \عددی{\overline{L}_B} فعال ہوں گے۔یوں  پتہ  کی نشاندہی کے مقام پر لفظ    حافظہ  سے  دفتر \دفترب میں  لکھا جا سکتا ہے (شکل \حوالہ{شکل_کمپیوٹر_جمع_اور_منفی}-ب)۔ ہمیشہ کی طرح ،   اس حال کے وسط میں آنے والے ساعت کے کنارہ چڑھائی پر مواد دفتر \دفترب میں منتقل ہو گا۔

\عددی{T_6} حال  کے دوران، \عددی{E_U} اور \عددی{\overline{L}_A} فعال ہو ں گے؛ لہٰذا دفتر \دفترالف تک جمع و منفی کار کا مخارج پہنچے گا (شکل  \حوالہ{شکل_کمپیوٹر_جمع_اور_منفی}-ج)۔ اس حال کے وسط میں جمع و منفی کار  کا مخارج دفتر \دفترالف منتقل ہو گا۔
...
\end{subfigure}
\caption{
معمولہ \جمع{}  و  \منفی{} ؛ (ا) \عددی{T_4} حال؛ (ب) \عددی{T_5} حال؛ (ج) \عددی{T_6} حال۔
}
\label{شکل_کمپیوٹر_جمع_اور_منفی}
\end{figure}

اتفاق سے،   دورانیہ تیاری اور  دورانیہ ردعمل  کی بدولت دفتر \دفترالف حالت دوڑ سے دو چار نہیں ہوتا۔ شکل \حوالہء{10.6c} میں  ساعت کے  کنارہ چڑھائی  پر دفتر \دفترالف کا  مواد تبدیل ہو گا، جس کی وجہ سے جمع و منفی کار کا مخارج تبدیل ہو گا۔ یہ نیا مواد دفتر \دفترالف  کے مداخل تک پہنچتا ہے، تاہم یہ مواد  ساعت کے کنارہ چڑھائی کے دو  تاخیر  بعد  یہاں پہنچے گا ( پہلی تاخیر   دفتر \دفترالف اور دوسری  تاخیر جمع و منفی کار کی بدولت ہو گی)۔ اس وقت تک دفتر \دفترالف  میں مواد لکھنے کا لمحہ گزر چکا ہوگا۔ یوں دفتر \دفترالف حالت دوڑ (جس میں ساعت کے  ایک  ہی کنارے پر  ایک سے زیادہ مرتبہ مواد بھرا جاتا ہو)  سے دو چار نہیں ہو گا۔

شکل  \حوالہ{شکل_کمپیوٹر_بازیابی_جمع_وقتیہ}  میں بازیابی اور  \قول{معمولہ \جمع{}  } کی وقتیہ ترسیمات  پیش ہیں۔معمولہ  بازیابی  ہمیشہ کی طرح \عددی{T_1} حال میں  دفتر پتہ میں برنامہ گنت کار کا مواد منتقل کرتا ہے؛ \عددی{T_2} حال میں  گنت کار کی گنتی میں ایک کا اضافہ کیا جاتا ہے؛ \عددی{T_3} حال میں دفتر ہدایت  کو ،  پتہ کی نشاندہی پر ، حافظہ سے ہدایت منتقل کی جاتی ہے۔
...
\عددی{T_4} حال کے دوران، \عددی{\overline{E}_I} اور \عددی{\overline{L}_M} فعال  ہوں گے؛ ساعت کے اگلے کنارہ چڑھائی پر، دفتر پتہ کو   دفتر  ہدایت سے جزو  پتہ منتقل ہو گا۔ \عددی{T_5} حال کے دوران، \عددی{\overline{CE}} اور \عددی{\overline{L}_B} فعال ہوں گے؛  لہٰذا ساعت کے کنارہ چڑھائی پر   دفتر \دفترب میں  پتہ کی نشاندہی پر حافظہ سے لفظ منتقل ہو گا۔ \عددی{T_6} حال کے دوران، \عددی{E_U} اور \عددی{\overline{L}_A} فعال ہوں گے؛ دفتر \دفترالف میں، ساعت کے کنارہ چڑھائی پر، جمع  و منفی کار کا  حاصل نتیجہ منتقل ہو گا۔

\جزوحصہء{معمولہ \منفی{}}
معمولہ \منفی{}  اور معمولہ \جمع{} ملتے جلتے ہیں۔ شکل \حوالہ{شکل_کمپیوٹر_جمع_اور_منفی}-الف اور ب میں معمولہ \منفی{} کے لیے  \عددی{T_4} اور \عددی{T_5}  حال کے دوران  فعال حصے دکھائے گئے ہیں۔ \عددی{T_6} حال کے دوران شکل \حوالہ{شکل_کمپیوٹر_جمع_اور_منفی}-ج کے جمع و منفی کار  کو بلند \عددی{S_U} (جو شکل میں نہیں دکھایا گیا)  بھیجا جاتا ہے۔ وقتیہ ترسیم شکل \حوالہ{شکل_کمپیوٹر_بازیابی_جمع_وقتیہ}    سے تقریباً  مکمل مماثلت رکھتی ہے۔ \عددی{T_1}  تا \عددی{T_5} حال کے دوران پست \عددی{S_U} اور \عددی{T_6} حال کے دوران بلند \عددی{S_U} تصور کریں۔

\جزوحصہء{معمولہ \برآمد{}}
فرض کریں  بازیابی پھیرا کے آخر میں دفتر ہدایت میں \برآمد{} کی ہدایت موجود ہو۔ یوں درج ذیل ہو گا۔
\begin{align*}
\text{\RL{دفتر ہدایت}}=1110\,xxxx
\end{align*}
قابو و ترتیب کار کو رمز کشائی کے لیے  جزو ہدایت  بھیجا جاتا ہے۔ رمز کشائی کے بعد   قابو و ترتیب کار   خارجی دفتر میں دفتر \دفترالف کا مواد منتقل کرنے کے لیے قابو لفظ جاری کرتا ہے۔

\برآمد{} کی ہدایت کے دوران فعال حصے شکل  \حوالہ{شکل_کمپیوٹر_برآمد_ہدایت}  میں پیش ہیں۔ چونکہ \عددی{E_A} اور \عددی{\overline{L}_O} فعال ہیں، لہٰذا ساعت کے اگلے کنارہ چڑھائی پر دفتر \دفترالف کی معلومات  خارجی دفتر میں  ، \عددی{T_4} حال کے دوران ، منتقل ہو گی۔ \عددی{T_5} اور \عددی{T_6} حال فارغ  ہیں۔
...
شکل \حوالہ{شکل_کمپیوٹر_بازیابی_برآمد_وقتیہ} میں  بازیابی اور \برآمد{} وقتیہ ترسیمات پیش ہیں۔  بازیابی حال   ہمیشہ کی طرح پتہ حال، بڑھوتری حال، اور حافظہ حال پر مشتمل ہو گا۔ \عددی{T_4} حال کے دوران، \عددی{E_A} اور \عددی{\overline{L}_O} فعال ہوں گے؛ لہٰذا ساعت کے اگلے کنارہ چڑھائی پر دفتر \دفترالف کی معلومات خارجی دفتر کو منتقل ہو گی۔
...
\جزوحصہء{\رک}
\رک کی ہدایت  پر عمل در آمد  کے دوران کسی دفتر کی ضرورت پیش نہیں آتی، لہٰذا  اس کے لیے معمولہ  قابو  درکار نہیں ہو گا۔ جب دفتر ہدایت میں درج ذیل موجود ہو
\begin{align*}
...
کمپیوٹر   الف کے چھ \عددی{T} حال ہیں، جن میں سے تین بازیابی اور تین تعمیلی ہیں ۔ ان چھ حال کو\اصطلاح{ مشینی پھیرا }\فرہنگ{پھیرا!مشینی}\حاشیہب{machine cycle}\فرہنگ{cycle!machine} کہتے ہیں (شکل  \حوالہ{شکل_کمپیوٹر_مشینی_پھیرے}-الف  دیکھیں)۔ ایک مشینی پھیرے میں ایک ہدایت  کی بازیابی اور تعمیل کی جاتی ہے۔  کمپیوٹر  الف کی ساعت  کا تعدد \عددی{\SI{1}{\kilo\hertz}}  ہے، لہٰذا اس کا دوری عرصہ \عددی{\SI{1}{\milli\second}} ہو گا۔ یوں ہر  مشینی پھیرا \عددی{\SI{6}{\milli\second}} لیگا۔

کئی کمپیوٹر میں  ہدایت کی بازیابی اور تعمیل کرنا  ایک سے زائد  مشینی پھیروں میں ممکن ہو گا۔ شکل  \حوالہ{شکل_کمپیوٹر_مشینی_پھیرے}-ب  میں دو  مشینی پھیروں  کی ہدایت کا وقتیہ ترسیم پیش ہے۔ اولین تین \عددی{T} حال  بازیابی پھیرا دیتے ہیں؛ تاہم تعمیلی پھیرے کو اگلے نو \عددی{T} حال درکار ہیں۔  دو مشینی پھیرے کی ہدایت  زیادہ پیچیدہ ہو گی جس کی تعمیل  کے لیے اضافی \عددی{T} حال درکار ہوں گے۔

ایک ہدایت کی بازیابی اور تعمیل کے لیے درکار \عددی{T} حال کو \اصطلاح{ ہدایتی پھیرا }\فرہنگ{پھیرا!ہدایتی}\حاشیہب{instruction cycle}\فرہنگ{cycle!instruction}کہتے ہیں۔  کمپیوٹر  الف میں ہدایتی پھیرا اور مشینی پھیرا ایک  برابر ہیں، جبکہ  شکل \حوالہ{شکل_کمپیوٹر_مشینی_پھیرے}-ب میں ہدایتی پھیرا دو مشینی پھیروں کے برابر ہے۔
...
%--------------------------------
\ابتدا{مثال}
 \عددی{8080\! / \! 8085}   کا معلوماتی کتابچہ  کہتا ہے\قول{ \نقل{}}  کی ہدایت  کی بازیابی اور تعمیل کے لیے تیرہ \عددی{T} حال درکار ہوں گے۔ اگر کمپیوٹر کی ساعت کا تعدد \عددی{\SI{2.5}{\mega\hertz}} ہو، اس  ہدایت کو کتنا وقت درکار ہو گا؟
...
%------------------------------------
\ابتدا{مثال}
شکل \حوالہ{شکل_کمپیوٹر_کنارہ_چڑھائی_وسط_میں}  میں  کمپیوٹر  الف کے چھ \عددی{T} حال دکھائے گئے ہیں۔ ساعت کا (تیر دار)   کنارہ چڑھائی   نصف حال گزر کر آتا ہے۔ ایسا کیوں ہے؟
...
حل:\quad
جدید کمپیوٹر کی طرح اس کمپیوٹر میں مواد کا تبادلہ بذریعہ \عددی{W}  گزرگاہ ہوتا ہے۔ تاہم دفتر  کی بغیر مسئلہ  بھرائی اس صورت ممکن ہو گی  جب دورانیہ تیاری اور  دورانیہ  ٹھیراؤ  مطمئن ہوں۔ نصف  دوری عرصہ انتظار   کر  کے دفتر میں  بھرائی ، دورانیہ تیاری کو مطمئن کرتا ہے؛ بھرائی کے بعد نصف دوری عرصہ کا انتظار، دورانیہ ٹھیراؤ کو مطمئن کرتا ہے۔ اسی لیے ساعت کا کنارہ چڑھائی  \عددی{T} حال کے عین وسط میں رکھا جاتا ہے (شکل  \حوالہ{شکل_کمپیوٹر_کنارہ_چڑھائی_وسط_میں})۔

نصف دوری عرصہ انتظار کرنے کی  دوسری وجہ بھی ہے۔ مواد ترسیل کرنے والے دفتر کا \قول{مجاز}   اشارہ فعال کرنے  سے \عددی{W} گزرگاہ  پر مواد ایک دم ڈلتا ہے۔ غیر مطلوبہ  برقی گنجائش اور تاروں کے    امالہ کی بدولت  گزرگاہ  تاروں میں برقی دباؤ کی درست  سطح  کے حصول میں وقت درکار ہوتا ہے۔ دوسرے لفظوں میں   \عددی{W} گزرگاہ  پر عبوری حال   پیدا ہو گا؛بوقت بھرائی درست مواد یقینی بنانے کے لیے ضروری ہے کہ  ا عبوری حال  کے اختتام  کا  انتظار کیا جائے۔
\انتہا{مثال}
%----------------------------

\حصہ{خرد برنامہ}
ہم جلد  کمپیوٹر    الف کے   نقشہ  پر غور کریں گے، لیکن اس سے قبل بہتر ہو گا ہم اس کی ہدایات کی تعمیل کو ایک  جدول میں،  جسے\اصطلاح{ خرد برنامہ }\فرہنگ{خرد برنامہ}\حاشیہب{microprogram}\فرہنگ{microprogram} کہتے ہیں،  یکجا کریں۔
...
\centering
\caption{\نقل{} ہدایت  کی سادس عشری خرد ہدایات۔}
...
\text{\RL{\برآمد{}}}&T_4&3F2H&E_A,\overline{L}_O\\
...
جدول \حوالہ{جدول_کمپیوٹر_خرد_برنامہ} میں  کمپیوٹر  الف کا خرد برنامہ پیش ہے، جس میں ہر کلاں ہدایت اور  اس کی تعمیل کے لیے درکار خرد ہدایات  دیے گئے ہیں۔ یہ  جدول  کمپیوٹر  الف کے معمولہ تعمیل   کا خلاصہ ہے۔ زیادہ جدید ہدایات کے لیے بھی ایسا جدول لکھا جا سکتا ہے۔

\حصہ{کمپیوٹر  الف کا نقشہ}
اس حصے میں  کمپیوٹر  الف کے مکمل نقشہ  پر غور کیا جائے گا۔ شکل  \حوالہ{شکل_کمپیوٹر_برنامہ_گنتکار}  تا شکل  \حوالہ{شکل_کمپیوٹر_قابو_دور} میں تمام مخلوط ادوار، برقی تاریں، اور اشارات دکھائے گئے ہیں۔ آگے پڑھتے ہوئے ان  اشکال سے رجوع کریں۔جہاں ضرورت ہو، مستعمل  مخلوط ادوار  کی معلومات انٹرنیٹ سے حاصل کریں۔
...
یاد رہے برنامہ نویسی کے دوران  \عددی{S_2} (یعنی \عددی{S_{2a}} اور \عددی{S_{2b}}) کے بازو \قول{ برنامہ لکھ } بیٹھک پر ہوں گے جس کی بدولت \عددی{AA_0} تا \عددی{AA_3} دستی  پتہ اور \عددی{D_0} تا \عددی{D_7} دستی  مواد حافظہ کو فراہم ہو گا۔
   ...
   حافظہ میں برنامہ اور مواد لکھنے کے بعد \عددی{S_2} کو \قول{دوڑ بیٹھک}  پر رکھ کر  کمپیوٹر کو چلنے کے لیے تیار کیا جاتا ہے۔
...
\kSfton[uu6]{0}{0}
\draw[thin](uu6-center)node[inner sep=0pt,text width=1cm, align=center,]{u6\\ 74LS219};
\draw(uu6cpb0)node[left]{\scriptsize{$\overline{\text{\RL{بیدار}}}$}};
\draw(uu6apb0)node[right]{\scriptsize{$\overline{\text{\RL{لکھ}}}$}};
...
\kSfton[uu7]{\ksepX}{0}
\draw[thin](uu7-center)node[inner sep=0pt,text width=1cm, align=center,]{u7\\ 74LS219};
\draw(uu7cpb0)node[left]{\scriptsize{$\overline{\text{\RL{بیدار}}}$}};
\draw(uu7apb0)node[right]{\scriptsize{$\overline{\text{\RL{لکھ}}}$}};
...
\draw[thin] [decorate,decoration={brace,amplitude=5pt,mirror,raise=5pt}]{}(kA|-lft)--++(8*\kw,0)node[pos=0.5,below,inner sep=0pt,align=center,yshift=-3ex]{\text{\RL{مخارج دفتر}}\\ \دفترالف};
...
\draw[thin][decorate,decoration={brace,amplitude=5pt,raise=5pt,mirror}](kA)--++(8*\kw,0)node[pos=0.5,below,yshift=-3ex,inner sep=0pt,align=center]{\text{\RL{مخارج دفتر}}\\ \regB};
\draw[thin]($(uu10bp0)!0.25!(uu11dp0)$)node[]{\دفترالف \text{\RL{دفتر}}};
\draw[thin]($(uu14bp0)!0.25!(uu15dp0)$)++(-0.75*\ksepX,0)node[]{\regB \text{\RL{دفتر}}};
\end{tikzpicture}
\caption{دفتر \دفترالف  اور جمع و منفی کار}
...
\draw[thin,decorate,decoration={brace,amplitude=5pt,raise =5pt}](uu18A.in 2 |-kSubTop)--(uu18D.in 2 |- kSubTop)node[pos=0.5,above,align=center,yshift=10pt]{\regB \text{\RL{مخارج دفتر}}};
\draw[thin,decorate,decoration={brace,amplitude=5pt,raise =5pt}](uu19A.in 2 |- kSubTop)--(uu19D.in 2 |- kSubTop)node[pos=0.5,above,align=center,yshift=10pt]{\regB \text{\RL{مخارج دفتر}}};
\draw[decorate,decoration={brace,amplitude=5pt,raise=5pt}] (uu16dp0|-kSubTop)--(uu16dp3|-kSubTop)node[above,align=center,pos=0.5,yshift=10pt]{\text{\RL{مخارج}}\\ \text{\RL{دفتر \دفترالف}}};
\draw[decorate,decoration={brace,amplitude=5pt,raise=5pt}] (uu17dp0|-kSubTop)--(uu17dp3|-kSubTop)node[above,align=center,pos=0.5,yshift=10pt]{\text{\RL{مخارج}}\\ \text{\RL{دفتر \دفترالف}}};
...
%==================================================================
\جزوحصہء{دفتر \دفترالف}
 مخلوط ادوار \عددی{u10} اور \عددی{u11}  ، جو \عددی{74LS173} ہیں  ،\قول{  دفتر \دفترالف } دیتے ہیں (شکل \حوالہ{شکل_کمپیوٹر_دفتر_الف_جمع_منفی_کار} دیکھیں)۔ دونوں مخلوط دور کے \عددی{1} اور \عددی{2} پنیے زمین سے جوڑ کر   مخارج دو حال بنایا گیا ہے۔دو حال مخارج جمع و منفی کار کو فراہم کیا گیا ہے۔ \عددی{u12} اور \عددی{u13} مخلوط دور (\عددی{74LS126})     سہ حال    سوئچ  ہیں جو بلند \عددی{E_A} کی صورت میں دفتر \دفترالف کا مخارج  \عددی{W} گزرگاہ پر ڈالتے ہیں۔

\جزوحصہء{جمع و منفی کار}
\عددی{u18} اور \عددی{u19} مخلوط دور \عددی{74LS86} ہیں۔ یہ بلا شرکت جمع گیٹ بطور قابو  کردہ  متمم کار  کا کردار ادا کرتے ہیں۔ پست \عددی{S_U} کی صورت میں  دفتر \دفترب کا مواد بغیر تبدیل ہوئے ان  گیٹ سے گزرتا ہے۔بلند \عددی{S_U} کی صورت میں \دفترب  کے مواد کا  تکملہ  \عددی{1} ان گیٹوں سے خارج ہو گا اور ساتھ ہی کمتر تر  رتبی بِٹ کے ساتھ \عددی{1} جمع ہو کر تکملہ \عددی{2} دے گا۔
...
\جزوحصہء{دفتر \دفترب اور خارجی دفتر}
\عددی{u14} اور \عددی{u15}، جو \عددی{74LS173} ہیں، مل کر \قول{ دفتر \دفترب } دیتے ہیں۔دونوں کے پنیا \عددی{1} اور \عددی{2} زمین سے جوڑ کر مخارج دو حال بنایا گیا ہے۔دفتر \دفترالف  کے مواد کے ساتھ  دفتر \دفترب کا مواد جمع کیا جاتا ہے یا اس سے دفتر \دفترب کا مواد  منفی کیا جاتا ہے۔
...
دھیان رہے \عددی{u24} کا آدھا حصہ  \قول{بلا ٹپک صاف و چل} اور باقی  \قول{بلا ٹپک قدم بہ قدم}  دور میں  مستعمل ہے۔  \عددی{u24}  مخلوط  دور  \عددی{74LS00}  کو ظاہر کرتا ہے جس میں   \عددی{2} داخلی  چو ضرب  متمم  گیٹ  پائے جاتے ہیں۔

\جزوحصہء{بلا ٹپک قدم بہ قدم دور}
یہ کمپیوٹر دو  طرز  میں چل سکتا ہے؛ دستی   یا خود کار۔\عددی{S_6}\اصطلاح{ ایک  قطب دو چال  }\فرہنگ{سوئچ!ایک قطب دو چال}\حاشیہب{spdt, single-pole double-throw}\فرہنگ{spdt} سوئچ ہے، جو \قول{  بلند   } بیٹھک پر یا  \قول{پست} بیٹھک پر بیٹھا  رہ سکتا ہے۔  دستی طرز میں  \عددی{S_6} ایک مرتبہ   \قول{بلند} اور ایک  مرتبہ  \عددی{پست}  بیٹھک  پر  بٹھانے  سے  ساعت کی  ایک مکمل   دھڑکن پیدا ہو گی۔ \قول{بلند} بیٹھک پر \عددی{S_6} بلند \عددی{CLK} دے گا؛  \قول{پست بیٹھک} پر \عددی{S_6} پست \عددی{CLK } دے گا۔ دوسرے لفظوں میں ، جیسے جیسے آپ \عددی{S_6} کو ایک بیٹھک سے دوسری بیٹھک پر     بٹھاتے ہیں، شکل \حوالہ{شکل_کمپیوٹر_ساعت_منبع_طاقت}  میں پیش،  \قول{ بلا ٹپک قدم بہ قدم دور } باری باری ایک ایک \عددی{T} حال پیدا ہو گا۔ یوں آپ  کمپیوٹر  کو  مختلف \عددی{T} حال سے گزار کر اس کا تفصیلی معائنہ  کر سکتے ہیں، جو  خرابی کی صورت میں کمپیوٹر ٹھیک کرنے میں مددگار ثابت ہو گا۔

\جزوحصہء{بلا ٹپک دستی و خود کار}
\عددی{S_7}\اصطلاح{ ایک  قطب دو چال  } سوئچ  ہے۔جب سوئچ  دستی بیٹھک پر  ہو، \عددی{u26} کا پنیا \عددی{1} بلند ہو گا اور یوں  قدم بہ قدم بتام فعال ہو گا  (یعنی \عددی{u24} کے پنیا \عددی{11}  پر موجود اشارہ \عددی{u26} سے گزر کر \عددی{u25} کے پنیا \عددی{11} پہنچ کر  \عددی{CLK} اور \عددی{\overline{CLK}} پیدا کرے گا)۔جب سوئچ  خود کار بیٹھک پر  بیٹھا ہو، کمپیوٹر خود کار  کام کریگا   (یعنی \عددی{u25} کے پنیا \عددی{11} تک   ساعت پیدا کرنے والا   اشارہ \عددی{u29}  کے پنیا \عددی{3}سے پہنچے گا)۔ \عددی{u25} کے دو ضرب متمم گیٹ \عددی{S_7} کو بلا ٹپک بناتے ہیں۔\عددی{u25} کے باقی دو  ضرب متمم گیٹ  قدم  با قدم ساعت یا خود کار ساعت  میں سے ایک کو \عددی{CLK} اور \عددی{\overline{CLK}} تک پہنچاتے ہیں۔
...
\draw[thin](uu24p10)-|node[left,yshift=3ex]{\text{\RL{قدم بہ قدم}}}(sw6.out 1)node[right]{\text{\RL{پست}}} (uu24p12)-|(sw6.out 2)node[right]{\text{\RL{بلند}}}  (sw6.in)node[above]{$S_6$}node[ground]{};
...
\عددی{u31} کے چار   نفی گیٹ  ہدایتی رمز بِٹ \عددی{I_7I_6I_5I_4} کا متمم دیتے ہیں (شکل \حوالہ{شکل_کمپیوٹر_حال_گنت_کار} دیکھیں)۔ \عددی{u32}، \عددی{u33}، اور \عددی{u34}ہدایتی  رموز سے  (جدول \حوالہ{جدول_کمپیوٹر_رموز} کے تحت) پانچ  ہدایات: \نقل{}، \جمع{}، \منفی{}، \برآمد{}، اور  \رک  حاصل کرتے ہیں۔یاد رہے، ایک وقت صرف ایک ہدایت فعال ہو گی۔ (\عددی{\overline{\text{\RL{\رک}}}} اشارہ پست فعال جبکہ باقی بلند فعال ہیں۔)

جب \قول{\رک}  دفتر ہدایت میں  ہو، \عددی{I_7I_6I_5I_4} بِٹ \عددی{1111} ہوں گے اور  \عددی{\overline{\text{\RL{\رک}}}}  پست ہو گا۔ یہ اشارہ   قدم بہ قدم  ساعت  کے  دور  میں  \عددی{u26} کے پنیا \عددی{13} اور خود کار ساعت کے دور میں \عددی{u29} کو جاتا ہے۔  جب \عددی{\overline{\text{\RL{\رک}}}}   فعال (پست) ہو کمپیوٹر کی دستی اور خود کار  ساعت  رک جائیں گی  لہٰذا \عددی{CLK} اور \عددی{\overline{CLK}} اشارے رک جائیں گے اور کمپیوٹر  کام کرنا روک  دے گا۔
...
\جزوحصہء{چلن}
کمپیوٹر سے کوئی کام لینے سے پہلے اس کے حافظہ میں  برنامہ  اور مواد بھرا جاتا ہے۔ برنامہ نچلے حافظہ اور مواد بالا حافظہ میں رکھ کر  \قول{صاف} بتام  دبا کر واپس  اٹھنے دیا جاتا ہے جس سے ایک لمحے کے لیے  \عددی{CLR} اور \عددی{\overline{CLR}} فعال ہوں گے۔ \عددی{CLK} اور \عددی{\overline{CLK}} ساعتی اشارے دفاتر کو  اور گنت کار چلاتے ہیں۔ قابو و ترتیب کار سے خارج  خرد ہدایت  ساعت کے کنارہ چڑھائی پر   عمل کا تعین کرتا ہے۔

ہر ایک  مشینی  پھیرا  بازیابی پھیرے سے آغاز کرتا ہے۔ \عددی{T_1} پتہ حال، \عددی{T_2} بڑھوتری حال، اور \عددی{T_3} حافظہ حال ہو گا۔ بازیابی پھیرے کے اختتام پر  دفتر ہدایت میں ہدایت پائی جائے گی۔  جزو ہدایت   کی رمز کشائی کے بعد  قابو قالب خود بہ خود   درست تعمیلی معمولہ پیدا کرتا ہے۔ تعمیلی پھیرا  کی تکمیل   پر چھلا گنت کار دوبارہ \عددی{T_1} سے آغاز کرتا ہے اور اگلا مشینی پھیرا شروع ہوتا ہے۔

دفتر ہدایت میں \قول{\رک}  ہدایت    بھرتے ہی  کمپیوٹر کام    کرنا  روک دے گا۔

\حصہ{خرد برنامہ نویسی}
ہر ایک تعمیلی پھیرے کے لیے درکار خرد ہدایات  کے حصول کا ایک طریقہ شکل \حوالہ{شکل_کمپیوٹر_قابو_دور} میں پیش کیا گیا ہے۔ زیادہ تعداد کی  ہدایات  کے لیے درکار قابو قالب بہت بڑا ہو گا جس میں سیکڑوں یا ہزاروں کی تعداد میں گیٹ مستعمل ہوں گے۔ اتنی زیادہ تعداد میں گیٹوں کو برقی تاروں کے ذریعہ آپس میں جوڑنا آسان نہیں۔ یہی وجہ ہے کہ تخلیق کاروں نے دیگر راہ تلاش کیے۔
...
پتے مختص کر کے  اور تعمیلی معمولہ شامل کرتے ہوئے ہم جدول \حوالہ{جدول_کمپیوٹر_خرد_برنامہ_حافظہ} میں پیش خرد ہدایات حاصل کر سکتے ہیں، جنہیں\موٹا{ قابو }  الفاظ کے پختہ حافظہ میں ذخیرہ کیا جا سکتا ہے۔  بازیابی  معمولہ  \عددی{0H} تا \عددی{2H} پتے پر، \نقل{} معمولہ \عددی{3H} تا \عددی{5H}، \جمع{} معمولہ \عددی{6H} تا \عددی{8H}، \منفی{} معمولہ \عددی{9H} تا \عددی{BH}، اور  \برآمد{}  معمولہ \عددی{CH} تا \عددی{EH} پر رکھے گئے ہیں۔

کسی بھی معمولہ تک رسائی کے لیے  درست پتہ  مہیا کرنا ہو گا۔مثلاً، \جمع{} معمولہ   کے لیے ہمیں \عددی{6H}، \عددی{7H}، اور \عددی{8H} پتے فراہم کرنا ہو گا۔ \برآمد{} معمولہ چلانے کے لیے \عددی{CH}، \عددی{DH}، اور \عددی{EH} پتے فراہم کرنا ہو گا۔ یوں کسی بھی معمولہ تک رسائی درج ذیل تین اقدام پر چلتے ہوئے ممکن ہو گی۔
\begin{enumerate}[1.]
\item
...
شکل \حوالہء{10۔16} میں کمپیوٹر  کی خرد  برنامہ  نویسی دکھائی گئی ہے، جو  \اصطلاح{پتہ  پختہ حافظہ}\فرہنگ{پتہ  پختہ حافظہ}\حاشیہب{address ROM}\فرہنگ{address!ROM} ، \اصطلاح{قابل   پیش  بھرائی}\فرہنگ{قابل پیش بھرائی}\حاشیہب{presettable}\فرہنگ{presettable} گنت کار، اور\اصطلاح{ قابو پختہ  حافظہ } \فرہنگ{قابو  پختہ حافظہ}\حاشیہب{control ROM}\فرہنگ{control ROM} پر مشتمل ہے۔پتہ حافظہ میں ، جدول \حوالہ{جدول_کمپیوٹر_خرد_برنامہ_حافظہ}     میں دیے گئے ، ہر  ہدایت کا  ابتدائی پتہ  پایا جاتا ہے۔ دوسرے لفظوں میں  پتہ حافظہ میں جدول \حوالہ{جدول_کمپیوٹر_پتہ_حافظہ} کا مواد پایا جاتا ہے۔ جیسا آپ دیکھ سکتے ہیں، \نقل{} معمولہ کا ابتدائی پتہ \عددی{0011} ، \جمع{} معمولہ کا  ابتدائی پتہ \عددی{0110} ہے، وغیرہ۔

جب بِٹ   \عددی{I_7I_6I_5I_4}  پتہ پختہ حافظہ   کو چلائیں،  ابتدائی پتہ پیدا ہو گا۔ مثلاً، اگر \جمع{} ہدایت زیر تعمیل ہو، \عددی{I_7I_6I_5I_4} میں \عددی{0001} ہو گا، جو  پتہ پختہ حافظہ کو  فراہم  ہو گا؛ پختہ حافظہ \عددی{0110} دے گا۔

\جزوحصہء{قابل پیش  بھرائی گنت کار}
جب \عددی{T_3} بلند ہو، قابل پیش بھرائی گنت کار کا\قول{  بھر} مداخل بلند ہو گا لہٰذا  پتہ پختہ حافظہ سے گنتکار   ابتدائی  گنتی    حاصل کرے گا۔ باقی \عددی{T} حال کے دوران گنت کار گنتی کرے گا۔

ابتدائی طور، صاف /  چل  بلا ٹپک دور  بلند \عددی{CLR} اشارہ پیدا کرتا ہے۔ جمع گیٹ کے مخارج پر نصب \عددی{RC} اس اشارے کا تفرق لیتے ہوئے ایک باریک\اصطلاح{  سوزن  }\فرہنگ{سوزن}\حاشیہب{spike}\فرہنگ{spike} پیدا کرتا ہے جو گنت کار کو صاف کرتی ہے۔ کمپیوٹر کی دوڑ   شروع ہونے  کے بعد \عددی{T_1} حال میں گنت کار کی گنتی \عددی{0000}، \عددی{T_2} حال میں \عددی{0001}، اور \عددی{T_3} حال میں \عددی{0010} ہو گی۔ بازیابی  کا ہر پھیرا  ایک سا ہو گا، چونکہ \عددی{T_1}، \عددی{T_2}، اور \عددی{T_3} حال کے دوران گنت کار  بالترتیب \عددی{0000}، \عددی{0001}، اور \عددی{0010} دے گا۔

دفتر ہدایت میں موجود  ہدایتی رمز   تعمیلی پھیرا قابو کرتا ہے۔ اگر \جمع{} ہدایت  بازیاب کی جائے، \عددی{I_7I_6I_5I_4} کے بِٹ \عددی{0001} ہوں گے۔ یہ ہدایتی رمز پتہ پختہ حافظہ کو چلاتے ہوئے \عددی{0110} (جدول \حوالہ{جدول_کمپیوٹر_پتہ_حافظہ} دیکھیں) پیدا کرے گا، جو قابل پیش بھرائی گنت کار کو بطور ابتدائی پتہ   فراہم کیا جاتا ہے۔ بلند \عددی{T_3} کے دوران ساعت کے اگلے کنارہ اترائی پر  \عددی{0110} قابل پیش بھرائی گنت کار میں  بھرا جائے گا۔ یوں گنت کار\قول{  \جمع{}  } معمولہ  کے  ابتدائی گنتی سے آغاز کرتے ہوئے آگے گنتا ہے۔ \عددی{T_4} حال کے دوران گنت کار کا مخارج \عددی{0110}،  \عددی{T_5} حال کے دوران \عددی{0111}، اور \عددی{T_6} حال کے دوران \عددی{1000} ہو گا۔

\عددی{T_1} حال کے   شروع  میں، \عددی{T_1} اشارے کا   پیش کنارہ تفرق   کرتے ہوئے  ایک  باریک مثبت   سوزن  پیدا کیا جاتا ہے ، جو گنت کار کو صاف کر کے  \عددی{0000} کرتی  ہے؛ یہ   بازیابی معمولہ  کا ابتدائی پتہ ہے۔ یوں ایک نئے مشین پھیرے کا آغاز ہو گا۔

\جزوحصہء{قابو پختہ حافظہ}
قابو پختہ حافظہ میں کمپیوٹر کے خرد ہدایات ذخیرہ کیے جاتے ہیں۔ بازیابی پھیرے کے دوران،  قابو پختہ حافظہ  کو \عددی{0000}، \عددی{0001}، اور \عددی{0010} پتہ فراہم کیا جاتا ہے، لہٰذا  یہ درج ذیل خارج کرے گا۔
\begin{align*}
&5E3H\\
&BE3H\\
&263H
\end{align*}
یہ خرد ہدایات، جو جدول \حوالہ{جدول_کمپیوٹر_خرد_برنامہ_حافظہ} میں پیش ہیں، پتہ حال، بڑھوتری حال، اور حافظہ حال پیدا کرتے ہیں۔

\قول{\جمع{}}  ہدایت  کی تعمیل کے دوران، قابو پختہ حافظہ کو تعمیلی پھیرے کے دوران \عددی{0110}، \عددی{0111}، اور \عددی{1000} پتے فراہم  ہوں گے۔ پختہ حافظہ کے  مخارج  بالترتیب درج ذیل ہوں گے۔
\begin{align*}
&1A3H\\
&2E1H\\
&3C7H
\end{align*}
جیسا ہم پہلے ذکر کر چکے، یہ خرد ہدایات \قول{\جمع{}}  کی تعمیل کراتے ہیں۔

فرض کریں \قول{\برآمد{}} ہدایت کی تعمیل  کی جا رہی ہے۔ ہدایتی رمز \عددی{1110} ہو گا اور  ابتدائی پتہ \عددی{1100} ہو گا  (جدول \حوالہ{جدول_کمپیوٹر_پتہ_حافظہ} دیکھیں)۔ تعمیلی پھیرے کے دوران،  گنت کار کے مخارج \عددی{1100}، \عددی{1101}، اور \عددی{1110} ہوں گے۔قابو پختہ حافظہ  کے مخارج \عددی{3F2H}، \عددی{3E3H}، اور \عددی{3E3H} ہوں گے (جدول \حوالہ{جدول_کمپیوٹر_خرد_برنامہ_حافظہ} دیکھیں)۔ یہ معمولہ دفتر \دفترالف کا مواد برآمدی  روزن  کو منتقل کرتا ہے۔

\جزوحصہء{متغیر مشینی پھیرا}
جدول \حوالہ{جدول_کمپیوٹر_خرد_برنامہ_حافظہ} میں  خرد ہدایت \عددی{3E3H} فارغ رہنے کی ہدایت ہے۔ یہ \نقل{}  معمولہ میں ایک مرتبہ اور \برآمد{} معمولہ میں دو  مرتبہ  پایا جاتا ہے۔  کمپیوٹر  الف میں فارغ ہدایت  استعمال کر کے تمام ہدایات کے لیے \اصطلاح{مقررہ مشینی پھیرا }\فرہنگ{مشینی پھیرا!مقررہ}\حاشیہب{fixed machine cycle}\فرہنگ{machine cycle!fixed} حاصل کیا جاتا ہے۔یوں ہر ہدایت ٹھیک چھ \عددی{T} حال کا ہو گا۔بعض کمپیوٹر میں   مقررہ مشینی پھیرا موزوں ہو گا۔ تاہم، جہاں تیز رفتار درکار ہو وہاں فارغ  ہدایت  سے چھٹکارا حاصل کر کے رفتار بڑھائی جا سکتی ہے۔

ایسا \عددی{T} حال جس میں فارغ  ہدایت موجود ہو کو  نظر انداز کرتے ہوئے آگے بڑھنے  سے رفتار بڑھائی جا سکتی ہے۔ شکل \حوالہء{10۔16} میں معمولی تبدیلی سے ایسا کرنا ممکن ہو گا۔ اس سے \نقل{} ہدایت کا  مشینی پھیرا  گھٹ کر پانچ \عددی{T} حال  (\عددی{T_1}، \عددی{T_2}، \عددی{T_3}، \عددی{T_4}، اور \عددی{T_5}) کا رہ جائے گا۔ برآمد ہدایت کا مشینی پھیرا گھٹ کر چار \عددی{T} حال   (\عددی{T_1}، \عددی{T_2}، \عددی{T_3}، اور  \عددی{T_4}) کا رہ جائے گا۔

\اصطلاح{ متغیر مشینی پھیرا }\فرہنگ{مشینی  پھیرا!متغیر}\حاشیہب{variable machine cycle}\فرہنگ{machine cycle!variable} حاصل کرنے کا ایک طریقہ شکل \حوالہء{10۔17}  میں  پیش ہے۔  \نقل{} ہدایت کے لیے \عددی{T_1} تا \عددی{T_5} حال  ہو بہو مقررہ مشینی پھیرا کی طرح ہیں۔  \عددی{T_6} حال  کے آغاز  میں  قابو پختہ حافظہ \عددی{3E3H} (یعنی فارغ خرد ہدایت)  پیدا کرے گا۔ ضرب متمم گیٹ اس ہدایت کو فوراً پہچان کر  پست \عددی{\overline{\text{\RL{فارغ}}}}  خارج کرتا ہے۔ جیسا شکل \حوالہء{10۔18} میں دکھایا گیا ہے،  ضرب گیٹ کی مدد سے  \عددی{\overline{\text{\RL{فارغ}}}} چھلا گنت کار کو مہیا کیا گیا ہے۔ چھلا گنت کار فوراً \عددی{T_1} حال  اختیار کر کے  نئے مشینی پھیرے کا آغاز کرتا ہے۔ یوں \نقل{} ہدایت چھ   سے  گھٹ کر پانچ حال   کا ہو گا۔

\برآمد{} ہدایت میں پہلا فارغ خرد ہدایت \عددی{T_5} حال میں پایا جاتا ہے۔ یوں \عددی{T_5} حال کے آغاز میں  قابو پختہ حافظہ \عددی{3E3H} دے گا جس کو ضرب متمم گیٹ پہچان کر پست  \عددی{\overline{\text{\RL{فارغ}}}} پیدا کر  کے چھلا گنت کار کو \عددی{T_1} حال اختیار کرنے پر مجبور کرتا ہے۔ یوں، \برآمد{} ہدایت  چھ حال سے گھٹ کر چار حال کا ہو گا۔

\اصطلاح{ خرد عامل  کار      }\فرہنگ{خرد عامل کار}(\اصطلاح{مائکروپراسیسر}\فرہنگ{مائکروپراسیسر}\فرہنگ{مائکروپراسیسر}\حاشیہب{microprocessor}) عموماً متغیر مشینی پھیرا  استعمال کرتے ہیں۔ مثال کے طور پر، \عددی{8085} میں ، تمام فارغ خرد ہدایت سے چھٹکارا حاصل کرتے ہوئے،  مشینی پھیرا  دو سے چھ \عددی{T} حال پر مشتمل ہو  گا۔
...
\جزوحصہء{خلاصہ}
 ...
 \حصہء{سوالات}
 %Q1
 \ابتدا{سوال}\شناخت{سوال_کمپیوٹر_پہلا}
 کمپیوٹر  الف کا   ( مثال \حوالہ{مثال_کمپیوٹر_برنامہ_الف} کی طرز پر ) ایسا برنامہ لکھیں جو   درج ذیل کا نتیجہ   ثنائی نمائشی تختی پر دکھائے۔
\begin{align*}
5+4-6
\end{align*}
مواد کے لیے \عددی{DH}، \عددی{EH}، اور \عددی{FH} پتے استعمال کریں۔
...
\end{center}
 ...
 %Q2
 \ابتدا{سوال}
 آپ نے سوال \حوالہ{سوال_کمپیوٹر_پہلا} میں برنامہ لکھا۔ اس کا ترجمہ مشینی زبان میں  کریں۔ مشینی زبان میں جواب ثنائی اور  سادس عشری   روپ میں پیش کریں۔
 \انتہا{سوال}
 %---------------
 %Q3
 \ابتدا{سوال}\شناخت{سوال_کمپیوٹر_تیسرا}
 درج ذیل حل کرنے کے لیے  کمپیوٹر کی مادری زبان میں برنامہ لکھیں۔ مواد کے لیے \عددی{BH} تا \عددی{FH} پتے استعمال کریں۔
 \begin{align*}
 8+4-3+5-2
 \end{align*}
...
\end{center}
 ...
 %Q5
 \ابتدا{سوال}
 \جمع{} ہدایت کی وقتیہ ترسیمات شکل میں پیش ہیں۔ \منفی{} ہدایت کی وقتیہ ترسیمات کھینچیں۔
 \انتہا{سوال}
 %-----------------
 %Q6
 \ابتدا{سوال}
 فرض کریں \عددی{8085} کی ساعت کا تعدد \عددی{\SI{3}{\mega\hertz}} ہے۔  \جمع{} ہدایت  کی بازیابی اور تعمیل کے لیے  چار \عددی{T} حال    درکار ہیں۔یہ کتنا وقت ہے؟
 \انتہا{سوال}
 %----------------------
 %Q7
 \ابتدا{سوال}
  کمپیوٹر   الف کے \نقل{} معمولہ کی خرد ہدایات کیا ہیں؟ \منفی{} معمولہ کے لیے کیا ہیں؟ جواب ثنائی اور سادس عشری روپ  میں پیش کریں۔ 
 
 جواب:
\قول{ \نقل{} } کے لیے  \عددی{1A3H}، \عددی{2C3H}، \عددی{3E3H}  یا \عددی{000110100011}، \عددی{001011000011}، \عددی{001111100011}؛
\منفی{} کے لیے \عددی{1A3H}، \عددی{2E1H}، \عددی{3CFH} یا \عددی{000110100011}، \عددی{001011100001}،\عددی{001111001111}؛
 \انتہا{سوال}
 %---------------------
 %Q8
 \ابتدا{سوال}
 فرض کریں ہم دفتر \دفترالف کا مواد دفتر \دفترب میں منتقل کرنا چاہتے ہیں۔ہمیں ایک نئی  خرد ہدایت درکار ہے۔ یہ خرد ہدایت کیا ہو گی؟ جواب ثنائی اور  سادس عشری روپ میں پیش کریں۔
 \انتہا{سوال}
 %-----------------
 %Q9
 \ابتدا{سوال}
 ...
 \begin{enumerate}[a.]
 \item
دفتر \دفترالف کا مواد  \عددی{\overline{CLK}} کے کنارہ چڑھائی پر کہ کنارہ اترائی پر تبدیل ہو گا؟
 اس لمحے \عددی{CLK} کا کنارہ چڑھائی ہو گا یا کنارہ اترائی؟
 \item
 برنامہ گنت کار کو بڑھانے کے لیے \عددی{C_P} بلند ہو گا یا پست؟
 \item
 برنامہ گنت کار صاف کرنے کے لیے \عددی{\overline{CLR}} بلند ہو گا یا پست؟
 \item
 برنامہ گنت کار کا مواد \عددی{W} گزرگاہ  پر  رکھنے کے لیے \عددی{E_P} بلند ہو گا یا پست؟
 \end{enumerate}
 
 جواب: (ا) کنارہ اترائی؛ \عددی{CLK} کا کنارہ چڑھائی ہو گا۔ (ب) بلند (ج) پست (د) بلند
 \انتہا{سوال}
 %-----------------------
 %Q10
 \ابتدا{سوال}
 ...
 \begin{enumerate}[a.]
 \item
 بلند \عددی{\overline{L}_A} کی صورت میں ساعت کے اگلے کنارہ چڑھائی پر  دفتر \دفترالف کے مواد کو کیا ہو گا؟
 \item
 اگر \عددی{\text{\RL{\دفترالف}}=00101100} اور   \عددی{\regB=11001110} ہوں تب بلند \عددی{E_A} کی صورت میں \عددی{W} گزرگاہ  پر کیا ہو گا؟
 \item
  اگر \عددی{\text{\RL{\دفترالف}}=00001111}،    \عددی{\regB=00000001}  ، اور \عددی{S_U=1} ہو  تب بلند \عددی{E_U} کی صورت میں \عددی{W} گزرگاہ  پر کیا ہو گا؟
 \end{enumerate}
 \انتہا{سوال}
 %-------------
 %Q11
 \ابتدا{سوال}
  ...
  \begin{enumerate}[a.]
  \item
  جب \عددی{S_5} صاف بیٹھک پر ہو کیا \عددی{\overline{CLR}} بلند یا پست ہو گا؟
  \item
  جب \عددی{S_6}  پست بیٹھک پر   ہو کیا \عددی{u24} کا پنیا \عددی{11} بلند یا پست ہو گا؟
  \item
  \عددی{u29} کے پنیا \عددی{3} پر ساعت  کا اشارہ موجود ہونے کے لیے \عددی{\overline{HLT}} بلند یا پست ہونا ہو گا؟
  \end{enumerate}
 ...
 %Q12
 \ابتدا{سوال}
 شکل  \حوالہ{شکل_کمپیوٹر_حال_گنت_کار} اور  شکل \حوالہ{شکل_کمپیوٹر_قابو_دور}  کو دیکھ کر درج ذیل کا جواب دیں۔
 \begin{enumerate}[a.]
 \item
 اگر \عددی{I_7I_6I_5I_4=1110} ہو، \عددی{u35} کے خارجی پنیوں میں صرف ایک بلند ہو گا۔ وہ پنیا کون سا ہے؟ (پنیا \عددی{12} اور \عددی{10}   نظرانداز کریں۔)
 \item
 جب \عددی{\overline{CLR}} پست ہوتا ہے، \عددی{T_1} تا \عددی{T_6} میں  کون سا بلند ہوتا ہے؟
 \item
\قول{ \نقل{} }اور \عددی{T_5} بلند ہیں۔ \عددی{u45} کے پنیا \عددی{6} پر کیا ہو گا؟
\item
\قول{\جمع{}} اور  \عددی{T_4} بلند ہیں۔ کیا \عددی{u45} کا  پنیا \عددی{12} پست یا بلند ہو گا؟
 \end{enumerate}
 \انتہا{سوال}
 %--------------------------
