...
ابتدائی طور، صاف /  چل  بلا ٹپک دور  بلند \عددی{CLR} اشارہ پیدا کرتا ہے۔ جمع گیٹ کے مخارج پر نسب \عددی{RC} اس اشارے کا تفرق لیتے ہوئے ایک باریک\اصطلاح{  سوزن  }\فرہنگ{سوزن}\حاشیہب{spike}\فرہنگ{spike} پیدا کرتا ہے جو گنت کار کو صاف کرتی ہے۔ کمپیوٹر کی دوڑ   شروع ہونے  کے بعد \عددی{T_1} حال میں گنت کار کی گنتی \عددی{0000}، \عددی{T_2} حال میں \عددی{0001}، اور \عددی{T_3} حال میں \عددی{0010} ہو گی۔ بازیابی  کا ہر پھیرا  ایک سا ہو گا، چونکہ \عددی{T_1}، \عددی{T_2}، اور \عددی{T_3} حال کے دوران گنت کار  بالترتیب \عددی{0000}، \عددی{0001}، اور \عددی{0010} دیگا۔
