...
دفتر \دفترالف کا مواد  \عددی{\overline{CLK}} کے کنارہ چڑھائی پر کہ کنارہ اترائی پر تبدیل ہو گا؟
 ...
 \begin{enumerate}[a.]
 \item
 اگر \عددی{I_7I_6I_5I_4=1110} ہو، \عددی{u35} کے خارجی پنیوں میں صرف ایک بلند ہو گا۔ وہ پنیا کونسا ہے؟ (پنیا \عددی{12} اور \عددی{10}   نظرانداز کریں۔)
 \item
 جب \عددی{\overline{CLR}} پست ہوتا ہے، \عددی{T_1} تا \عددی{T_6} میں  کونسا بلند ہوتا ہے؟
 \item
