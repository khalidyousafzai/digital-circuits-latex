...
\begin{align*}
C_PE_P\overline{L}_M\overline{CE}\,\,\, \overline{L}_I\overline{E}_I\overline{L}_AE_A\,\,\,S_UE_U\overline{L}_B\overline{L}_O=\text{\RL{قابو لفظ}}
\end{align*}
...
\موٹا{\نقل{}} اس کمپیوٹر کی ایک ہدایت ہے جو  کہتی ہے دفتر ا  الف میں مواد نقل کریں۔ پوری ہدایت میں  اس مواد کا  سادس عشری پتہ بھی دیا جاتا ہے جو دفتر \دفترالف میں بھرا جائے گا، لہٰذا مکمل ہدایت درج ذیل ہے جو جدول \حوالہ{جدول_کمپیوٹر_ہدایات} میں  پیش ہے۔
\begin{align*}
\LDA{پتہ}
\end{align*}
 یوں\قول{\نقل{8H}} کہتی ہے کہ عارضی حافظہ کے پتہ \عددی{8H} پر درج معلومات کو دفتر \دفترالف میں نقل کریں۔ اس ہدایت پر عمل کرنے کے بعد دفتر \دفترالف میں  اور حافظہ کے مقام  \عددی{8H} پر ایک جیسا مواد  پایا جائے گا۔ یوں  درج ذیل صورت میں
\begin{align*}
R_8=1111\,0000
\end{align*}
...
\جزوحصہء{\ADD{}}
کمپیوٹر کی یہ ہدایت دو اعداد جمع کرنے کو کہتی  ہے۔پہلا عدد دفتر \دفترالف میں ہو گا جبکہ دوسرے عدد کا پتہ مکمل ہدایت میں شامل ہو گا؛ نتیجہ دفتر \دفترالف میں محفوظ ہو گا، لہٰذا دفتر \دفترالف میں پہلے سے موجود مواد زائل ہو گا۔یوں   اگر دفتر \دفترالف میں \عددی{2_{10}} اور حافظہ کے مقام \عددی{9H} پر \عددی{3_{10}} ہو:
\begin{align*}
0000\,0010&=\regA\\
0000\,0011=&R_9
\end{align*}
...
کمپیوٹر   حافظہ میں ہدایات اور مواد بھرنے کے لئے ہمیں ایسی زبان استعمال کرنی ہو گی جو کمپیوٹر  سمجھ سکے۔ جدول \حوالہ{جدول_کمپیوٹر_رموز}  میں  کمپیوٹر  کے \اصطلاح{ہدایتی رموز }\فرہنگ{ہدایتی رمز}\حاشیہب{operation codes, op codes}\فرہنگ{op code}    پیش ہیں۔ یوں \قول{ \نقل{}  } کی ہدایت کے لئے کمپیوٹر \عددی{0000} کا  ثنائی رمز استعمال کرتا ہے۔\قول{ \جمع{} } کے لئے \عددی{0001}، \قول{ \منفی{}} کے لئے \عددی{0010}، \قول{  \برآمد{}}کے لئے \عددی{1110}، اور \قول{ \رک} کے لئے \عددی{1111} رمز  استعمال ہو گا۔ 
\begin{table}
...
\begin{align*}
C_PE_P\overline{L}_M\overline{CE}\quad  \overline{L}_I\overline{E}_I\overline{L}_AE_A\quad S_UE_U\overline{L}_B\overline{L}_O =&\text{\RL{قابو لفظ}}\\
...
\begin{align*}
\SI{400}{\nano\second}=\frac{1}{\SI{2.5}{\mega\hertz}}=\frac{1}{f}=T
\end{align*}
...
\begin{align*}
\SI{5.2}{\micro\second}=13\times \SI{400}{\nano\second}
\end{align*}
\انتہا{مثال}
%------------------------------------
\ابتدا{مثال}
...
جدول \حوالہ{جدول_کمپیوٹر_خرد_برنامہ} میں  کمپیوٹر  الف کا خرد برنامہ پیش ہے، جس میں ہر کلاں ہدایت اور  اس کی تعمیل کے لئے درکار خرد ہدایات  دیے گئے ہیں۔ یہ  جدول  کمپیوٹر  الف کے طریق تعمیل   کا خلاصہ ہے۔ زیادہ جدید ہدایات کے لئے بھی ایسا جدول لکھا جا سکتا ہے۔
...
\end{center}
 ...
 %Q7
 \ابتدا{سوال}
  کمپیوٹر   الف کے \نقل{} طریق کی خرد ہدایات کیا ہیں؟ \منفی{} طریق کے لئے کیا ہیں؟ جواب ثنائی اور سادس عشری روپ  میں پیش کریں۔
