...
\foreach \n/\m in{0/{a_0},1/{a_1}}{\draw[thin](\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pl\n)node[]{\small{$\m$}};}
...
\def\kshiftY{#3}
\kBOX[#1]{#2}{#3}{12}{3}
\foreach \n/\lbl in {0/12,2/5}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}}; %left
\foreach \n/\lbl in {2/15,4/2,6/6,8/9}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};       %bottom
\foreach \n/\lbl in {1/13}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};		%right
\foreach \n/\lbl in {0/1,1/3,2/8,3/10,5/16,7/4,9/7,11/11}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};
%\foreach \n in {1,2}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
%\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
%\foreach \n in {3,4}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
%\foreach \n in {0}\draw(\kref\d\pb\n)++(0,\knshift)node[ocirc]{};
