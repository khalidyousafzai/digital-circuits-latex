...
\def\nnx{#4}
\def\nny{#5}
\def\kBOXpin{#6}				%named it because all variables here are global do not want to interfere with the outside
\pgfmathsetmacro{\nx}{\nnx-1}
\pgfmathsetmacro{\ny}{\nny-1}
\def\p{p}			%pin tip
\def\a{a}			%left pins
...
% TTL used in SAP-1
%74107-B   JK-FF
%numbering code 0=z, 1=o, 2=t, 3=Th, 4=f, 5=Fv, 6=s, 7=Sv, 8=e, 9=n
\newcommand{\kozSvB}[3][u0]{
\def\kref{#1}
%\def\p{p}			%pin tip
%\def\pb{pb}			%pin base
%\def\pl{pl}			%pin label
...
\def\kshiftY{#3}
\kBOX[#1]{#2}{#3}{4}{4}{0.5}
\foreach \n/\lbl in {0/13,1/10,2/4,3/1}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}}; %left
\foreach \n/\lbl in {0/3,1/6,2/8,3/11}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};    %bottom
\foreach \n/\lbl in {0/7,3/14}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};		%right
\foreach \n/\lbl in {0/2,1/5,2/9,3/12}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};
%\foreach \n in {0}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
%\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
%\foreach \n in {3,4}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
%\foreach \n in {0}\draw(\kref\d\pb\n)++(0,\knshift)node[ocirc]{};
}
%==============================
%numbering code 0=z, 1=o, 2=t, 3=Th, 4=f, 5=Fv, 6=s, 7=Sv, 8=e, 9=n
%74LS126 RotateRight
\newcommand{\kotsACW}[3][u0]{
\def\kref{#1}
\def\kshiftX{#2}
\def\kshiftY{#3}
\kBOX[#1]{#2}{#3}{4}{4}{0.5}
\foreach \n/\lbl in {0/2,1/5,2/9,3/11}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}}; %left
\foreach \n/\lbl in {0/1,1/4,2/10,3/13}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};   %bottom
\foreach \n/\lbl in {0/3,1/6,2/8,3/11}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};	%right
\foreach \n/\lbl in {0/7,3/14}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};
%\foreach \n in {0}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
%\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
%\foreach \n in {3,4}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
%\foreach \n in {0}\draw(\kref\d\pb\n)++(0,\knshift)node[ocirc]{};
...
%numbering code 0=z, 1=o, 2=t, 3=Th, 4=f, 5=Fv, 6=s, 7=Sv, 8=e, 9=n
%74LS126 RotateLeft
\newcommand{\kotsCW}[3][u0]{
\def\kref{#1}
\def\kshiftX{#2}
\def\kshiftY{#3}
\kBOX[#1]{#2}{#3}{4}{4}{0.5}
\foreach \n/\lbl in {0/11,1/8,2/6,3/3}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}}; %left
\foreach \n/\lbl in {0/7,3/14}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};   %bottom
\foreach \n/\lbl in {0/12,1/9,2/5,3/2}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};	%right
\foreach \n/\lbl in {0/13,1/10,2/4,3/1}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};
%\foreach \n in {0}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
%\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
%\foreach \n in {3,4}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
%\foreach \n in {0}\draw(\kref\d\pb\n)++(0,\knshift)node[ocirc]{};
...
\def\knshift{0.07}
\kBOX[#1]{#2}{#3}{4}{5}{0.5}
\foreach \n/\lbl in {0/3,1/12,2/10,3/6,4/4}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}};
\foreach \n/\lbl in {0/5,1/7,2/9,3/11}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};
\foreach \n/\lbl in {0/2,3/8,4/16}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};
\foreach \n/\lbl in {0/1,1/15,2/14,3/13}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};
\foreach \n in {0}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
\foreach \n in {0}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
}
...
%numbering code 0=z, 1=o, 2=t, 3=Th, 4=f, 5=Fv, 6=s, 7=Sv, 8=e, 9=n
%74LS173
\newcommand{\koSvt}[3][u0]{
\def\kref{#1}
\def\kshiftX{#2}
\def\kshiftY{#3}
\kBOX[#1]{#2}{#3}{4}{5}{0.5}
\foreach \n/\lbl in {0/8,1/2,2/1,3/15,4/16}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}}; %left
\foreach \n/\lbl in {0/3,1/4,2/5,3/6}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};       %bottom
\foreach \n/\lbl in {2/7,3/10,4/9}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};		%right
\foreach \n/\lbl in {0/14,1/13,2/12,3/11}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};
\foreach \n in {1,2}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
%\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
\foreach \n in {3,4}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
%\foreach \n in {0}\draw(\kref\d\pb\n)++(0,\knshift)node[ocirc]{};
\def\n{2}
...
\def\kshiftY{#3}
\kBOX[#1]{#2}{#3}{8}{3}{0.5}
\foreach \n/\lbl in {0/12,1/14,2/5}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}}; %left
\foreach \n/\lbl in {3/15,4/2,5/6,6/9}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};       %bottom
\foreach \n/\lbl in {1/13}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};		%right
\foreach \n/\lbl in {0/1,1/3,2/8,3/10,4/16,5/4,6/7,7/11}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};  %upper pins
%\foreach \n in {1,2}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
%\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
%\foreach \n in {3,4}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
%\foreach \n in {0}\draw(\kref\d\pb\n)++(0,\knshift)node[ocirc]{};
...
%numbering code 0=z, 1=o, 2=t, 3=Th, 4=f, 5=Fv, 6=s, 7=Sv, 8=e, 9=n
%74LS157
\newcommand{\koFvSv}[3][u0]{
\def\kref{#1}
\def\kshiftX{#2}
\def\kshiftY{#3}
\kBOX[#1]{#2}{#3}{8}{5}{0.5}
\foreach \n/\lbl in {0/15,1/8,2/1,4/16}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}}; %left
\foreach \n/\lbl in {4/12,5/9,6/7,7/4}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};    %bottom
%\foreach \n/\lbl in {0/5,2/3}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};		%right
\foreach \n/\lbl in {0/14,1/11,2/5,3/2,4/13,5/10,6/6,7/3}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};
\foreach \n in {0}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
%\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
%\foreach \n in {3,4}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
%\foreach \n in {0}\draw(\kref\d\pb\n)++(0,\knshift)node[ocirc]{};
...
%numbering code 0=z, 1=o, 2=t, 3=Th, 4=f, 5=Fv, 6=s, 7=Sv, 8=e, 9=n
%NE555
\newcommand{\kFvFvFv}[3][u0]{
\def\kref{#1}
\def\kshiftX{#2}
\def\kshiftY{#3}
\kBOX[#1]{#2}{#3}{3}{3}{0.5}
\foreach \n/\lbl in {0/6,2/7}\draw(\kref\a\pb\n)--(\kref\a\p\n) (\kref\a\pnum\n)node[]{\scriptsize{$\lbl$}}; %left
\foreach \n/\lbl in {0/2,2/1}\draw(\kref\b\pb\n)--(\kref\b\p\n) (\kref\b\pnum\n)node[]{\scriptsize{$\lbl$}};       %bottom
\foreach \n/\lbl in {0/5,2/3}\draw(\kref\c\pb\n)--(\kref\c\p\n) (\kref\c\pnum\n)node[]{\scriptsize{$\lbl$}};		%right
\foreach \n/\lbl in {0/8,2/4}\draw(\kref\d\pb\n)--(\kref\d\p\n) (\kref\d\pnum\n)node[]{\scriptsize{$\lbl$}};
%\foreach \n in {1,2}\draw(\kref\a\pb\n)++(-\knshift,0)node[ocirc]{};
%\foreach \n in {0,1,2,3}\draw(\kref\b\pb\n)++(0,-\knshift)node[ocirc]{};
%\foreach \n in {3,4}\draw(\kref\c\pb\n)++(\knshift,0)node[ocirc]{};
%\foreach \n in {0}\draw(\kref\d\pb\n)++(0,\knshift)node[ocirc]{};
