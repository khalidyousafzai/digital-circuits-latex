...
سادہ کمپیوٹر کا   ( مثال \حوالہ{مثال_کمپیوٹر_برنامہ_الف} کی طرز پر ) ایسا برنامہ لکھیں جو   درج ذیل کا نتیجہ   ثنائی نمائشی تختی پر دکھائے۔
\begin{align*}
5+4-6
\end{align*}
...
\end{center}
 ...
 %Q2
 \ابتدا{سوال}
 آپ نے سوال \حوالہ{سوال_کمپیوٹر_پہلا} میں برنامہ لکھا۔ اس کا ترجمہ مشینی زبان میں  کریں۔ مشینی زبان میں جواب ثنائی اور اساس سولہ  روپ میں پیش کریں۔
 \انتہا{سوال}
 %---------------
 %Q3
...
\end{center}
 ...
 %Q4
 \ابتدا{سوال}
 گزشتہ سوال میں لکھا گیا برنامہ مشینی زبان میں ترجمہ کریں۔ جواب ثنائی اور اساس سولہ  روپ میں پیش کریں۔
 \انتہا{سوال}
 %---------------------
 %Q5
 \ابتدا{سوال}
 ...
 %Q7
 \ابتدا{سوال}
 ہمارے سادہ کمپیوٹر کی نقل طریق کی خرد ہدایات کیا ہیں؟ منفی طریق کے لئے کیا ہیں؟ جواب ثنائی اور اساس سولہ روپ  میں پیش کریں۔
...
منفی کے لئے \عددی{1A3H}، \عددی{2E1H}، \عددی{3CFH} یا \عددی{000110100011}، \عددی{001011100001}،\عددی{001111001111}؛
 ...
 %Q8
 \ابتدا{سوال}
 فرض کریں ہم دفتر \عددی{A} کا مواد دفتر \عددی{B} میں منتقل کرنا چاہتے ہیں۔ہمیں ایک نئی  خرد ہدایت درکار ہے۔ یہ خرد ہدایت کیا ہو گی؟ جواب ثنائی اور اساس سولہ روپ میں پیش کریں۔
 \انتہا{سوال}
 %-----------------
 %Q9
 \ابتدا{سوال}
