...
\draw[thin] (1.5*\ksepX,-8*\ksepY+3*\kpsep)node[]{\text{\RL{دفتر پتہ}}};
...
سوئچ کا باز و ایک بیٹھک سے دوسری  بیٹھک منتقل کرتے وقت  بازو  ٹپکیاں کھا کر بیٹھتا ہے، جس سے متعدد اشارات پیدا ہو سکتے ہیں۔ ہمیں عموماً ایک مستند  اشارہ درکار ہو گا۔ شکل \حوالہ{شکل_کمپیوٹر_ساعت_منبع_طاقت} میں  \عددی{S_6} کا بازو \قول{صاف}  پر  بٹھانے سے ٹپکیوں کی بدولت  \قول{صاف} پر متعدد \عددی{0} اور \عددی{1}     پیدا ہوں گے، تاہم \عددی{u24} کے دو ضرب متمم گیٹ صرف ایک  پست \عددی{\overline{CLR}} پیدا کرتے ہیں۔ گویا، یہ دور سوئچ کو \اصطلاح{ بلا  ٹپک }\فرہنگ{بلا ٹپک}\حاشیہب{debounced}\فرہنگ{debounce} بناتا ہے۔
