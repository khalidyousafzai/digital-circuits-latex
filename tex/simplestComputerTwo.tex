...
کمپیوٹر با میں\قول{  عرف  } کے لئے ایک  تا  چھ    علامت (حرف یا ہندسے ) استعمال کیے جا سکتے ہیں، تاہم پہلی علامت کا  لازماً ایک  حرف  ہونا ہو گا۔ عرف کے  لئے  عموماً معنی خیز الفاظ استعمال کئے جائیں گے،  تاہم ہندسوں کا استعمال جائز ہے۔ جائز عرف کی  مثالیں درج ذیل ہے۔
 \begin{center}
\begin{tabular}{r}
دوبارہ\\ 
یہاں\\
