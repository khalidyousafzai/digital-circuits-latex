...
یہ ہدایت وقت ضائع کرنے کے لیے استعمال کی جاتی ہے۔ \sNOP ہدایت بازیاب  کرنے کے لیے اور اس کی تعمیل میں کل چار \عددی{T} حال  درکار ہوتے ہیں۔کئی \sNOP  ملا کر وقتی وقفہ  پیدا کیا جا سکتا ہے۔ مثال کے طور پر،  \sNOP کو \قول{دائرے } میں رکھ  کر ، اس کی تعمیل \عددی{100} مرتبہ کر کے  \عددی{400\, T} حال کے برابر وقفہ پیدا کیا جا سکتا ہے۔
...
اس معمولہ کی کل  لمبائی  \عددی{8} بائٹ ہے۔ کمپیوٹر با کے نرم افزار کے طور پر اس معمولہ    کا ترجمہ مشینی زبان میں کر کے  \عددی{F010H} تا \عددی{F017H} پتے  پر رکھا جا سکتا ہے۔ ایسا کرنے کے بعد، \CALL{F010H} ہمیں \عددی{\SI{1}{\milli\second}} وقفہ  دے گا۔
 \انتہا{مثال}
 %---------------------------
 %ex 11.17
