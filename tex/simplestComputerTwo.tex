...
\end{align*}
ہم شکل  \حوالہ{شکل_کمپیوٹر_با_چوکور_موج} میں دکھائے گئے\اصطلاح{ چوکور موج  }\فرہنگ{چوکور موج}\حاشیہب{square wave}\فرہنگ{square wave} کی  طرح  اشارہ  روزن \عددی{4} کے بِٹ \عددی{5} پر بھیجیں گے۔  چوکور اشارہ \عددی{\SI{1911}{\micro\second}} کے لیے بلند، اور \عددی{\SI{1911}{\micro\second}} کے لیے پست ہو گا۔ بلند اور پست حصے ملا کر \عددی{\SI{3822}{\micro\second}} دیتے ہیں، جو \عددی{\SI{261.63}{\hertz}} تعدد دیگا۔  پیدا کردہ  آواز سائن نما ہونے کے بجائے چوکور ہے، لہٰذا  یہ  سریلی  نہیں ہو گی۔
