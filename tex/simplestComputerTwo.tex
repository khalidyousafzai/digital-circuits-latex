...
\اصطلاح{متصل یا قریب  پتے کا انداز}\فرہنگ{پتہ!متصل یا قریب  انداز}\حاشیہب{immediate addressing}\فرہنگ{addressing!immediate} فراہم کرنے کا انداز   اس سے مختلف ہے۔ مواد کا پتہ فراہم کرنے کی بجائے، ہم مواد فراہم کرتے ہیں۔ مثلاً، درج ذیل ہدایت میں  درکار بائٹ  ،  حافظہ میں ہدایتی رمز کے فوراً بعد   پایا جاتا ہے۔
\begin{center}
\begin{tabular}{r}
\MVI{\regA}{بائٹ}
\end{tabular}
