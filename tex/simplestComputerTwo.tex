...
\end{figure}
سہ  حال دفتر کے درآمدی اور برآمدی پنیوں کو   مخلوط  دور ساز   اندرونی طور  پر  آپس میں جوڑ  سکتا ہے۔ اس سے نا صرف تاروں کی برقی گنجائش کم ہو گی بلکہ  درآمدی و برآمدی   پنیوں کی تعداد بھی کم ہو گی۔ مثلاً، شکل \حوالہ{شکل_کمپیوٹر_با_دو_طرفہ_دفتر}-ب  میں آٹھ کے بجائے چار درآمدی و برآمدی پنیے ہیں۔ 
...
\draw[thick](kAnchor)coordinate(kL)++(\kdimX+\ksepXW,0.5*\kdimY)coordinate(kA)++(0,0.5*\kAr)coordinate(aa) 
 ...
 \draw(kAnchor)++(0,-1*\ksepYA)coordinate(kAnchor)   [thick] rectangle ++(\kdimX,\kdimY)
 node[pos=0.5,rectangle,inner sep=0pt,text width=2.75cm,align=center]{$\SI{64}{\kilo\byte}$ \\ \RTL{حافظہ}};
 %arrow head vertical
...
بازیابی پھیرے کے دوران، دفتر پتہ کو برنامہ گنت کار  \عددی{16} بِٹ پتہ فراہم کرے گا، جس کے بعد  حافظہ کے مطلوبہ مقام  سے    دو حال\قول{ دفتر پتہ}   مخاطب  ہو گا۔کمپیوٹر با میں \عددی{0000H} تا \عددی{07FFH}   پتہ \عددی{2K}  پختہ حافظہ  استعمال  کرتا ہے ۔ پختہ حافظہ  میں موجود برنامے کو  \اصطلاح{ نگران }\فرہنگ{نگران}\حاشیہب{monitor}\فرہنگ{monitor}کہتے ہیں۔    برقی طاقت  کی فراہمی  پر  کمپیوٹر کی ابتدائی  صورت طے کرنا، ٹائپ کار تختی  کے مواد کی   تشریح، اور ایسے دیگر کام \قول{ نگران برنامہ  } کی ذمہ داری ہے۔ باقی \عددی{62K}    عارضی حافظہ کے لیے  مختص ہے۔ یوں \عددی{0800H} تا \عددی{FFFFH} پتے عارضی حافظہ کے لیے استعمال ہوں گے۔
...
\جزوحصہء{دفتر ہدایت}
کمپیوٹر با کی ہدایات کی تعداد  کمپیوٹر الف کی ہدایات کی تعداد سے زیادہ ہے لہٰذا اس کا دفتر ہدایت \عددی{4} بِٹ کے بجائے \عددی{8} بِٹ ہے۔ آٹھ بِٹ  میں \عددی{256} ہدایات  سموئے جا  سکتے ہیں۔ کمپیوٹر با کے کُل \عددی{42} ہدایتی رمز ہیں جنہیں \عددی{8} بِٹ میں ڈالنا مسئلہ پیش نہیں کریگا۔ آٹھ بِٹ ہدایتی رمز استعمال کرتے ہوئے کمپیوٹر با کی ہدایات کو    \عددی{8080\! / \! 8085}  کی    ہدایات  (جو خود آٹھ بِٹ ہیں)کے ہم آہنگ رکھا  گیا ہے۔ کمپیوٹر با کی تمام ہدایات  \عددی{8080\! / \! 8085}  کی ہدایات کے عین مطابق ہیں۔
...
دفتر \عددی{\regA} کے ساتھ جمع  یا اس سے منفی ہونے والا مواد دفتر \عددی{\regB} کے بجائے \موٹا{ عارضی دفتر }میں رکھا جاتا ہے۔ یوں دفتر \عددی{\regB} دیگر کام کے لیے استعمال کیا جا سکتا ہے۔ عارضی دفتر اور دفتر \عددی{\regB} کے علاوہ کمپیوٹر با میں دفتر \عددی{\regC} بھی پایا جاتا ہے۔ یوں کمپیوٹر دوڑ کے دوران  مواد کی ترسیل میں ہم زیادہ لچک سے کام لے سکتے ہیں۔
...
کمپیوٹر با کی کُل \عددی{42} ہدایات ہیں۔ آئیں ان میں سے  راجع ہدایات  پر غور کریں۔

\جزوحصہء{\sLDA اور \sSTA}
\قول{\sLDA}   کی ہدایت  وہی ہے جو پہلے تھی: مخاطب مقام   (نشان زد مقام) سے دفتر \عددی{\regA} میں حافظہ سے مواد ڈالنا۔  فرق فقط  اتنا ہے کہ  کمپیوٹر با کی رسائی  \عددی{0000H} تا \عددی{FFFFH}  مقامات تک    ہے۔ مثال کے طور پر،    \قول{\LDA{2000H}} سے مراد حافظہ کے مقام  \عددی{2000H} سے دفتر \عددی{\regA} میں مواد نقل کرنا ہے۔

ہدایت کے مختلف حصوں میں فرق کرنے کے لیے   بعض اوقات   ہدایت کے   پہلے حصے  کو \اصطلاح{ ہدایتی رمز }\فرہنگ{ہدایتی رمز}\حاشیہب{opcode}\فرہنگ{opcode} جبکہ باقی حصے کو  \اصطلاح{رقم زیر عمل }\فرہنگ{رقم زیر عمل}\حاشیہب{operand}\فرہنگ{operand} کہتے ہیں۔ یوں      \قول{\LDA{2000H}} کی ہدایت  میں\قول{ \sLDA } کو  \موٹا{ہدایتی رمز }اور  \قول{\عددی{2000H} } کو  \موٹا{رقم زیر عمل}  کہیں گے۔ یوں \اصطلاح{ہدایتی رمز }\فرہنگ{ہدایتی رمز}کے دو مختلف معنی لیے جا سکتے ہیں؛ یہ ہدایت کے لیے یا ہدایت کے ثنائی رمز کے لیے استعمال کیا جا سکتا ہے۔ اصل معنی متن سے   واضح    ہو گی۔
...
\جزوحصہء{  \sMVI}
ہدایت \قول{\sMVI} کہتی ہے   دفتر میں متصل  (قریب مہیا کردہ)مواد\قول{   لاد  } (جیسا گھوڑے پر بوجھ\قول{ لادنا } ہو گا)۔یہ کمپیوٹر سے کہتی ہے  کہ  ہدایت رمز کے بعد پیش  (قریب یا متصل)مواد کو   دیے گئے دفتر میں ڈالے۔  \قول{لاد } اور  \قول{قریب }  سے اس کا  ہدایتی رمز \قول{ \sMVI } نکلا ہے۔ ہدایت \sMVI کو  \قول{لاد قریب} پڑھیں۔مثال کے طور پر، 
\begin{align*}
\MVI{\regA}{\kop{37H}}
\end{align*}
...
\جزوحصہء{ہدایتی رمز}
جدول \حوالہ{شکل_کمپیوٹر_ہدایتی_رمز} میں کمپیوٹر با کی تمام ہدایات پیش ہیں۔(ہدایتی رمز چھوٹا رکھنے کی خاطر اس کا عمل بیان کرنے والے الفاظ جوڑ کر چھوٹا نام پیدا کیا جاتا ہے؛ آپ نے یہ عمل \sMVI کی ہدایت میں دیکھا۔) یہ \عددی{8080\! / \! 8085} کی ہدایتی رمز ہیں۔ جیسا آپ دیکھ سکتے ہیں\قول{  \sLDA}  کا ہدایتی رمز \عددی{3A} ہے، \قول{\sSTA}  کا ہدایتی رمز \عددی{32} ہے، وغیرہ۔ باب  پڑھتے ہوئے اس جدول سے رجوع کریں۔
\begin{table}
...
%ex 11.1
\ابتدا{مثال}
دفتر \دفترالف میں  \زیرعمل{49H}، دفتر \دفترب میں \زیرعمل{4AH}، اور دفتر \دفترج میں \زیرعمل{4BH}  ڈالنے کے لیے برنامہ لکھیں؛ اس کے بعد دفتر \دفترالف کا مواد حافظہ کے  مقام \زیرعمل{6285H} پر رکھیں۔
...
\end{tabular}
\end{center}
کا  ہدایتی رمز  پہلے پتہ پر  اور رقم  زیر عمل بائٹ دوسرے پتے  پر رکھا گیا ہے۔ تمام \عددی{2} بائٹ ہدایات کے لیے  ایسا ہو گا: ہدایتی رمز  پہلے دستیاب  پتے پر جبکہ رقم زیر عمل بائٹ اگلے پتے پر رکھا  جائے گا۔ درج ذیل ہدایت   \عددی{3} بائٹ لمبی ہے (ہدایتی رمز \عددی{1} بائٹ جبکہ رقم زیر عمل مواد \عددی{2} بائٹ ہے)۔
\begin{center}
\begin{tabular}{r}
\STA{\kop{6285H}}
\end{tabular}
...
ہدایت \sSTA کا ہدایتی رمز \زیرعمل{32H} ہے۔ یہ بائٹ پہلے دستیاب پتہ ، \زیرعمل{2006H} ، پر رکھا  گیا ہے۔ اس ہدایت  میں دیا گیا پتہ (\زیرعمل{6285H}) دو بائٹ لمبا ہے۔ زیریں بائٹ \زیرعمل{85H} اگلے پتہ  (\زیرعمل{2007H}) پر، اور بالا بائٹ \زیرعمل{62H}  اس سے اگلے پتے  (\زیرعمل{2008H}) پر رکھا گیا ہے۔
 ...
 پتہ  بظاہر الٹ کیوں رکھا گیا  (یعنی زیریں بائٹ  کے بعد بالا بائٹ )؟   اولین  \عددی{8080} میں ایسا کیا گیا۔ اس  (اولین)  خرد عامل کار کے ساتھ ہم آہنگی کی وجہ سے  \عددی{8085}  اور  دیگر خرد عامل کار میں  یہی طریقہ اختیار کیا گیا۔ یوں   زیریں بائٹ زیریں پتے پر، اور بالا بائٹ بالا پتے پر رکھا جاتا ہے۔
...
ہدایت \sADD کہتی ہے دفتر \دفترالف کے ساتھ دیے گئے دفتر کا مواد \قول{جمع } کر کے نتیجہ دفتر \دفترالف میں ڈال۔ مثلاً،
\begin{center}
\begin{tabular}{r}
\ADD{\regB}
\end{tabular}
...
اسی طرح \sSUB کہتی ہے دیے گئے دفتر کا مواد دفتر \دفترالف سے  \قول{منفی } کر کے دفتر \دفترالف میں نتیجہ رکھ۔ دیے گئے دفتر کا مواد تبدیل نہیں ہو گا۔ \SUB{\regC} دفتر \دفترج کا مواد دفتر \دفترالف کے مواد سے منفی کر کے نتیجہ دفتر \دفترالف میں رکھے گی۔
...
بعض اوقات ہم  دفتر کا مواد  بڑھانا یا گھٹانا چاہتے ہیں۔بڑھوتری کے لیے ہدایت \sINR ہے (یہ ہدایت  \قول{بڑھا } پڑھی جائے گی)؛ یہ کمپیوٹر سے کہتی ہے ، دیے گئے دفتر کے مواد میں \عددی{1} کا اضافہ کر۔ دفتر کے مواد میں  کمی لانے کی ہدایت \sDCR ہے، جو دیے گئے دفتر کے مواد میں \عددی{1} کی کمی پیدا کرتی ہے (یہ ہدایت \قول{\, گھٹا} پڑھی جائے گی)۔ ان ہدایات کی مختلف اشکال درج ذیل ہیں۔
\begin{center}
\begin{tabular}{r}
\INR{\regA}\\
\INR{\regB}\\
...
\pgfmathsetmacro{\kAngA}{50}
\pgfmathsetmacro{\ksepX}{6}
\draw[thick](0,0)--++(0,2*\kL+\kA)  (\kA,0)--++(0,\kL)coordinate(aa) ++(0,\kA)coordinate(bb)--++(0,\kL);
\draw[thick](aa)--++(\kAngA:\kL)  (bb)--++(\kAngA:\kL)coordinate(cc);

\draw[thick](-\ksepX,0)--++(0,3*\kL+\kA+0.1)  (-\ksepX-\kA,0)--++(0,3*\kL+\kA+0.1);
\draw[decorate,decoration={brace,raise=3pt,amplitude=5pt}](0,0)--++(0,\kL+\kA-0.1)coordinate[pos=0.5,xshift=-10pt](kA);
\draw[decorate,decoration={brace,raise=3pt,amplitude=5pt,mirror}](-\ksepX,0)--++(0,\kL+\kA-0.1)coordinate[pos=0.5,xshift=10pt](kB);
\draw[latex-](kB)--(kA)node[pos=0.5,fill=white]{تنا};

\draw[decorate,decoration={brace,raise=3pt,amplitude=5pt}](0,\kL+\kA)--++(0,\kL)coordinate[pos=0.5,xshift=-10pt](kC);
\draw[decorate,decoration={brace,raise=3pt,amplitude=5pt,mirror}](-\ksepX,\kL+\kA)--++(0,\kL)coordinate[pos=0.5,xshift=10pt](kD);
\draw[latex-](kD)--(kC)node[pos=0.5,fill=white,rectangle,inner sep=0pt,align=center,text width=2.5cm]{\RTL{شرط غیر مطمئن}};

\draw[decorate,decoration={brace,raise=3pt,amplitude=5pt,aspect=0.6}](bb)++(\kAngA:0.2)--(cc)coordinate[pos=0.6,shift={(90+\kAngA:0.35)}](kE);
\draw[decorate,decoration={brace,raise=3pt,amplitude=5pt,mirror}](-\ksepX,2*\kL+\kA+0.1)--++(0,\kL)coordinate[pos=0.5,xshift=10pt](kF);
\draw[-latex](kE) to [out=90,in=0]node[pos=0.7,fill=white,rectangle,inner sep=0pt, text width=2.5cm,align=center]{\RTL{شرط مطمئن}}(kF);
\draw(0.5*\kA,0)node[below,yshift=-1ex]{(الف)};
\draw(-\ksepX-0.5*\kA,0)node[below,yshift=-1ex]{(ب)};
\end{tikzpicture}
\caption{شاخ کا تصور}
\label{شکل_کمپیوٹر_با_شاخ_تصور}
\end{figure}

\جزوحصہء{\sJMP}
نئی شاخ پر چلنے کی ایک ہدایت \sJMP ہے؛ یہ کمپیوٹر کو اگلی ہدایت دیے گئے  پتے  سے بازیاب کرنے کو کہتی ہے۔\sJMP ہدایت کے ساتھ پتہ ہو گا جو برنامہ گنت کار میں ڈال دیا جاتا ہے۔ مثال کے طور پر،
\begin{center}
\begin{tabular}{c}
\JMP{\kop{3000H}}
\end{tabular}
...
آئیں اس عمل  پر  غور کریں۔ فرض کریں، \JMP{3000H} مقام \عددی{2005H} پر  موجود ہے (شکل  \حوالہ{شکل_کمپیوٹر_با_شاخ}-الف دیکھیں)۔ بازیابی پھیرے کے اختتام پر، برنامہ گنت کار میں درج ذیل ہو گا۔
\begin{align*}
\regPC = \kop{2006H}
\end{align*}
...
\regPC = \kop{3000H}
\end{align*}
اگلا  بازیابی پھیرا، اگلی ہدایت \عددی{2006H} کے بجائے \عددی{3000H} سے پڑھے گا (شکل \حوالہ{شکل_کمپیوٹر_با_شاخ}-الف  دیکھیں)۔
...
شکل  \حوالہ{شکل_کمپیوٹر_با_شاخ}-ب میں   دونوں صورتوں کی وضاحت کی گئی ہے۔ اگر منفی کی شرط   مطمئن ہو، کمپیوٹر اگلی ہدایت کے لیے \عددی{3000H}   کی  شاخ (\عددی{3000H}  پر موجود شاخ)  لے  گا۔ اگر منفی شرط مطمئن  نہ ہو، کمپیوٹر شاخ کیے بغیر \اصطلاح{ سیدھا گزر کر }\فرہنگ{سیدھا گزرنا}\حاشیہب{fall through}\فرہنگ{fall through}    اگلی ہدایت اٹھائے گا۔
...
حل:\quad
شکل  \حوالہ{شکل_کمپیوٹر_با_بہاو}  میں برنامے کا بہاؤ دکھایا گیا ہے۔ \MVI{\regC}{03H} ہدایت دفتر \دفترج میں \عددی{03H} ڈالتی ہے۔ \DCR{\regC}  اس مواد  کو گھٹا کر \عددی{02H} کرتی ہے۔ یہ صفر سے زیادہ ہے؛ لہٰذا جھنڈا صفر پست ہو گا، اور \JZ{2009H}  ہدایت نظرانداز ہو گی۔ \JMP{2002H} ہدایت کمپیوٹر کو واپس  \DCR{\regC}ہدایت پر بھیجتی ہے۔
...
\end{tabular}
\end{center}
دفتر  \دفترج بطور قابل  پیش قیمت بھرائی گنت کار کردار ادا کرتا ہے۔ اسی لیے بعض اوقات  ہم اسے \قول{\, گنت کار } کہتے ہیں۔
...
%example 11.7
\ابتدا{مثال}
کمپیوٹر خریدتے وقت  آپ اس کا   \اصطلاح{نرم افزار }\فرہنگ{نرم افزار}\حاشیہب{software}\فرہنگ{software} (سافٹ وئیر) بھی خریدیں گے۔ ایک برنامہ جو آپ خرید سکتے ہیں\اصطلاح{  مترجم   } ہے۔ آپ علامتی روپ میں برنامہ لکھ کر  مترجم کی مدد اس کا ترجمہ  مشینی زبان میں  کرتے ہیں۔ دوسرے لفظوں میں، اگر آپ کے پاس مترجم ہو، آپ کو دستی ترجمہ کرنے کی ضرورت  نہیں  ہو گی؛ کمپیوٹر آپ کے لیے کام کرے گا۔

 مثال \حوالہ{مثال_کمپیوٹر_با_دائرہ} میں  دیا گیا برنامہ   مادری زبان کے روپ میں لکھیں۔ \اصطلاح{عرف }\فرہنگ{عرف}\حاشیہب{label}\فرہنگ{label} اور \اصطلاح{تبصرہ }\فرہنگ{تبصرہ}\حاشیہب{comments}\فرہنگ{comments}شامل کریں۔
...
&\JZ{\text{\RL{اختتام}}}& ؛صفر  کے لیے پرکھیں\\
...
مشینی زبان میں ترجمہ کرتے ہوئے، وقف ناقص (؛)  اور  اس لکیر پر اس کے بعد جو کچھ ہو ، کو مترجم  نظر انداز کرتا ہے۔  کیوں؟ وجہ یہ ہے کہ مترجم برنامے اسی طرح لکھے جاتے ہیں۔ وقف ناقص کمپیوٹر کو بتاتا  ہے کہ جو کچھ  آگے لکھا گیا ہے، برنامہ نویس کے ذاتی استعمال  اور یاداشت کے لیے ہے۔ 

شاخ اور طلبی  کے ساتھ\قول{ عرف  } کا استعمال مددگار ثابت ہوتا ہے۔ کمپیوٹر کی مادری زبان میں برنامہ لکھتے وقت  ہم عموماً نہیں جانتے کہ شاخ یا طلبی ہدایت کے ساتھ کیا پتہ شامل کریں۔اعدادی پتے کے بجائے \قول{عرف } استعمال کرنے سے  برنامے کا بہاؤ  سمجھنا  زیادہ  آسان ہو گا۔ مترجم ان عرف  کو دیکھتے ہوئے شاخ اور طلبی  ہدایات میں  درست پتے شامل کرتا ہے۔ ہم مطلوبہ پتے کا  عرف  رکھ کر پتے کو اسی عرف سے یاد کرتے ہیں۔ ہم دفاتر اور مواد  کے عرف بھی رکھتے ہیں۔
...
آپ کو صرف اتنا یاد رکھنا ہو گا کہ شاخ اور طلبی ہدایات کے ساتھ استعمال کے لیے  آپ کوئی بھی  عرف  استعمال کر سکتے ہیں۔ اسی عرف کے آخر میں  \عددی{:} چسپاں کر کے  اس ہدایت کے آگے لکھیں جس پر آپ شاخ کرنا  چاہتے ہیں۔ جب مترجم آپ کے برنامے کو پڑھتا ہے یہ نشان \عددی{(:)} مترجم کو خبردار کرتا ہے کہ اس  موقع پر  عرف  استعمال کیا گیا ہے۔

کمپیوٹر با میں\قول{  عرف  } کے لیے ایک  تا  چھ    علامت (حرف یا ہندسے ) استعمال کیے جا سکتے ہیں، تاہم پہلی علامت کا  لازماً ایک  حرف  ہونا ہو گا۔ عرف کے  لیے  عموماً معنی خیز الفاظ استعمال کیے جائیں گے،  تاہم ہندسوں کا استعمال جائز ہے۔ جائز عرف کی  مثالیں درج ذیل ہے۔
 \begin{center}
\begin{tabular}{r}
دوبارہ\\ 
یہاں\\
...
\end{tabular}
\end{center}
پہلے دو  عرف   سادہ الفاظ ہیں؛ تیسرا  عرف \قول{تختی پڑھ}   کہنا چاہتا ہے؛ چوتھا اور پانچواں  عرف بے معنی   ہیں، تاہم ان کا استعمال جائز ہے۔ عرف کی لمبائی پر چھ علامتوں کی  پابندی اور پہلی علامت    پر  حرف ہونے کی   پابندی  ، عام  دستیاب مترجم    بھی عائد کرتے ہیں۔
\انتہا{مثال}
%----------------------------
%example 11.8
\ابتدا{مثال} 
...
دوبارہ: & \ADD{\regB}& ؛ اعشاری \عددی{12} جمع کریں\\
&\DCR{\regC}& ؛گنتکار گھٹائیں\\
&\JNZ{دوبارہ}& ؛صفر کے لیے پرکھیں\\
& \HLT & ؛ کمپیوٹر روک دیں
\end{tabular}
\end{center}

یہ برنامہ نسبتاً سادہ ہے۔ اس میں ایک \sJMP ہدایت اور ایک عرف کم ہے۔ جب تک گنتکار  صفر  سے بڑا ہو، \sJNZ کمپیوٹر کو واپس\قول{ دوبارہ } پر بھیجے گی۔ جب گنتکار صفر ہو جائے، برنامہ \sJNZ سے سیدھا گزر کر \sHLT تک پہنچے گا۔
\انتہا{مثال}
%-------------------------
%ex 11.10
\ابتدا{مثال}
...
اس طرح سوچیں:  ابتدائی حالت تعین کرنے والی ہدایات کی ضرب  دینے کے عمل سے کوئی تعلق نہیں۔ یہ صرف  ان اعداد سے تعلق رکھتی ہیں جنہیں ضرب کرنا مقصود ہو۔ ذیلی معمولہ صرف اس  حصے پر مشتمل ہو گا جس کی ضرب کرنے سے تعلق ہو۔
...
\جزوحصہء{\sANI}
کمپیوٹر با میں متصل منطقی ہدایات بھی موجود ہیں۔ \sANI کہتی ہے \قول{دفتر \دفترالف کا منطقی ضرب   متصل (قریبی)  بائٹ کے ساتھ } حاصل کر۔ مثال کے طور پر اگر
\begin{align*}
\regA=0101\,1110
\end{align*} 
...
\جزوحصہء{\sORI}
یہ ہدایت\قول{ دفتر \دفترالف کا منطقی جمع متصل (قریب) بائٹ کے ساتھ }حاصل کرنے کو کہتی ہے۔ ہدایتی رمز  کے بعد دیے گئے بائٹ کا منطقی جمع دفتر \دفترالف کے ساتھ حاصل کر کے نتیجہ دفتر \دفترالف میں ڈالا جائے گا۔ یوں اگر
\begin{align*}
\regA=0011\,1000
\end{align*}
...
\جزوحصہء{\sXRI}
یہ ہدایت\قول{ متصل  (قریب)بائٹ کے ساتھ بلا شرکت جمع } دیتی ہے۔ یوں اگر 
\begin{align*}
\regA=0001\,1100
\end{align*}
...
یہ ہدایت وقت ضائع کرنے کے لیے استعمال کی جاتی ہے۔ \sNOP ہدایت بازیاب  کرنے کے لیے اور اس کی تعمیل میں کُل چار \عددی{T} حال  درکار ہوتے ہیں۔کئی \sNOP  ملا کر وقتی وقفہ  پیدا کیا جا سکتا ہے۔ مثال کے طور پر،  \sNOP کو \قول{دائرے } میں رکھ  کر ، اس کی تعمیل \عددی{100} مرتبہ کر کے  \عددی{400\, T} حال کے برابر وقفہ پیدا کیا جا سکتا ہے۔
...
\end{align*}
ہدایت \عددی{\ANI{\kop{01H}}} میں متصل (قریب)  بائٹ درج ذیل ہے
\begin{align*}
0000\,0001
\end{align*}
...
%ex 11.14
\ابتدا{مثال}
متوازی  مخارج  کے بجائے ہم  روزن \عددی{4} سے مواد  سلسلہ وار    برآمد کرنا چاہتے ہیں۔  مذکورہ بالا برنامے میں تبدیلی پیدا کرتے ہوئے جواب (\عددی{59H} یا \عددی{4EH}) روزن \عددی{4} کے بِٹ \عددی{0} سے  سلسلہ وار خارج کریں۔
...
\جزوحصہء{\عددی{T} حال}
کمپیوٹر با کا قابو و ترتیب کار کا برنامہ  متغیر مشینی پھیرے کے لیے   ہے۔ یوں بعض ہدایات کی تعمیل باقی ہدایات کی تعمیل سے  زیادہ  لے گی۔ جیسا آپ کو یاد ہو گا، خرد برنامہ نویسی کا مقصد پختہ حافظہ میں قابو  معمولے ذخیرہ کرنا ہے، جہاں سے انہیں ضرورت کے پیش  اٹھایا جا سکتا ہے۔

جدول  \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال} اور جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال_الف}  میں  ہر ایک ہدایت  اور ہدایت کی تعمیل کے لیے درکار \عددی{T} حال کی تعداد پیش ہے (ان ہدایات کو ایک جدول میں اس لیے پیش نہیں کیا گیا چونکہ ایسا  جدول ایک صفحہ میں سمویا نہیں جا تا)۔ مثلاً، \ADD{\regB} کی تعمیل چار \عددی{T} حال میں ہو گی، \ANI{بائٹ} کی تعمیل  سات میں،  اور \sCALL کی اٹھارہ میں، وغیرہ۔ وقتیہ استعمال میں \عددی{T} حال کی تعداد جاننا ضروری ہو گا۔

دھیان رہے کہ \sJM کو  درکار \عددی{T} حال  کی تعداد \عددی{10/7} ہے۔شاخ لینے کی صورت میں درکار  \عددی{T} حال کی تعداد \عددی{10} اور سیدھا گزرنے کی صورت میں \عددی{7} ہے۔ یہی تصور باقی مشروط شاخ ہدایات کے لیے بھی  ہے؛ شاخ  کی صورت میں درکار \عددی{T} حال کی تعداد  \عددی{10}  اور شاخ نہ لینے کی صورت میں \عددی{7} ہو گی۔
...
\جزوحصہء{جھنڈے}
جیسا آپ جانتے ہیں، بعض ہدایات کی تعمیل کے دوران دفتر \دفترالف منفی   یا  صفر ہو   سکتا ہے، جس سے  بالترتیب جھنڈا منفی اور جھنڈا  صفر اثر انداز ہوں گے۔ شکل  \حوالہ{شکل_کمپیوٹر_با_جھنڈے} میں کمپیوٹر با کے جھنڈے   بلند کرنے کے ادوار پیش ہیں۔

\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\kA}{1}
\pgfmathsetmacro{\ksepA}{2*\kA/9}
\pgfmathsetmacro{\kp}{1.25}
\pgfmathsetmacro{\ksepX}{3}
\pgfmathsetmacro{\ksepY}{2.25}
\kDFF[uu0]{\ksepX}{0}
\kDFF[uu1]{\ksepX}{\ksepY}
\draw(uu0-north)node[above,yshift=1ex,text width=3cm,rectangle,inner sep=0pt,align=center]{\RTL{جھنڈا صفر}};
\draw(uu1-north)node[above,yshift=1ex,text width=3cm,rectangle,inner sep=0pt,align=center]{\RTL{جھنڈا علامت}};
\draw[thin](uu0p1)--++(-1,0)node[and port,anchor=out,number inputs=2](uu2){};
\draw[thin](uu2.in 1)--++(-1,0)coordinate(kS);
\draw[thick](kS) to [out=120,in=0]++(-\kA,0.5*\kA)coordinate(tt)  (kS) to [out=-120,in=0]++(-\kA,-0.5*\kA)coordinate(bb)  ;
\draw[thick,name path=kk] (bb)++(0.1*\kA,-0.5*\kA)coordinate(kbot) to [out=90,in=-60](bb) to [out=60,in=-60](tt) to [out=60,in=-90]++(0.1*\kA,0.5*\kA);
\draw[thin](uu1p1)--++(-1,0)node[and port,number inputs=2,anchor=out](uu3){};
\draw[thick](kS)++(0.04,0)node[ocirc]{};
\path[thin,name path=kkk] (kbot)++(-\kp,1*\ksepA)--++(1.25*\kp,0);
\draw[thin,name intersections={of=kk and kkk,by=ki}] (kbot)++(-\kp,1*\ksepA)--(ki);
\path[thin,name path=kkk] (kbot)++(-\kp,2*\ksepA)--++(1.25*\kp,0);
\draw[thin,name intersections={of=kk and kkk,by=ki}] (kbot)++(-\kp,2*\ksepA)--(ki);
\path[thin,name path=kkk] (kbot)++(-\kp,3*\ksepA)--++(1.25*\kp,0);
\draw[thin,name intersections={of=kk and kkk,by=ki}] (kbot)++(-\kp,3*\ksepA)--(ki);
\path[thin,name path=kkk] (kbot)++(-\kp,4*\ksepA)--++(1.25*\kp,0);
\draw[thin,name intersections={of=kk and kkk,by=ki}] (kbot)++(-\kp,4*\ksepA)--(ki);
\path[thin,name path=kkk] (kbot)++(-\kp,5*\ksepA)--++(1.25*\kp,0);
\draw[thin,name intersections={of=kk and kkk,by=ki}] (kbot)++(-\kp,5*\ksepA)--(ki);
\path[thin,name path=kkk] (kbot)++(-\kp,6*\ksepA)--++(1.25*\kp,0);
\draw[thin,name intersections={of=kk and kkk,by=ki}] (kbot)++(-\kp,6*\ksepA)--(ki);
\path[thin,name path=kkk] (kbot)++(-\kp,7*\ksepA)--++(1.25*\kp,0);
\draw[thin,name intersections={of=kk and kkk,by=ki}] (kbot)++(-\kp,7*\ksepA)--(ki);
\path[thin,name path=kkk] (kbot)++(-\kp,8*\ksepA)--++(1.25*\kp,0);
\draw[thin,name intersections={of=kk and kkk,by=ki}] (kbot)++(-\kp,8*\ksepA)--(ki)coordinate[pos=0.5](kH);
\draw[thick](kbot)++(-\kp,-1*\ksepA) rectangle ++(-1,10*\ksepA)node[pos=0.5,inner sep=0pt,text width=1cm,align=center]{\RTL{دفتر\\ \دفترالف}};
\draw[thin](uu3.in 1)-|(kH);
\draw[thin](uu3.in 2)--(uu2.in 2)--++(0,-1)node[below]{$L_F$};
\draw[thin](uu1p2)--++(-0.4,0)coordinate(kA)--(kA|-uu0p2)coordinate(kB)--++(0,-1)node[below]{$CLK$} (uu0p2)--(kB);
\draw(uu0p6)node[right]{$Z$};
\draw(uu1p6)node[right]{$S$};
\end{tikzpicture}
\caption{جھنڈوں کا بلند ہونا۔}
\label{شکل_کمپیوٹر_با_جھنڈے}
\end{figure}
...
ایسا نہیں کہ تمام ہدایات جھنڈوں پر اثر انداز ہوتی ہیں۔ جیسا جدول  \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال} اور جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال_الف}  میں دکھایا گیا ہے \sADD، \sANA، \sANI، \sDCR، \sINR، \sORA، \sSUB، \sXRA، اور \sXRI وہ ہدایات ہیں جو جھنڈوں پر اثر انداز ہوتی ہیں۔ صرف یہ ہدایات کیوں؟  اس لیے کہ شکل  \حوالہ{شکل_کمپیوٹر_با_جھنڈے}  میں \عددی{L_F} اشارہ صرف اس وقت بلند ہو گا جب ان  ہدایات  کی تعمیل ہو۔  ان ہدایات کے لیے \عددی{L_F} بِٹ کی  خرد برنامہ نویسی سے یہ ممکن بنایا جاتا ہے۔ دوسرے لفظوں میں، قابو پختہ حافظہ میں ہم مذکورہ بالا ہدایات کے لیے \عددی{L_F} بِٹ  بلند   رکھتے ہیں، جبکہ باقی ہدایات کے لیے  ہم \عددی{L_F} بِٹ  پست رکھتے ہیں۔
...
\end{tabular}
\end{center}
یہ\اصطلاح{ بلا واسطہ پتہ کے  انداز}\فرہنگ{پتہ!بلا واسطہ انداز}\حاشیہب{direct addressing}\فرہنگ{addressing!direct} کی مثال ہیں۔

\اصطلاح{متصل یا قریب  پتے کا انداز}\فرہنگ{پتہ!متصل یا قریب  انداز}\حاشیہب{immediate addressing}\فرہنگ{addressing!immediate} فراہم کرنے کا انداز   اس سے مختلف ہے۔ مواد کا پتہ فراہم کرنے کے بجائے، ہم مواد فراہم کرتے ہیں۔ مثلاً، درج ذیل ہدایت میں  درکار بائٹ  ،  حافظہ میں ہدایتی رمز کے فوراً بعد   پایا جاتا ہے۔
\begin{center}
\begin{tabular}{r}
\MVI{\regA}{بائٹ}
\end{tabular}
\end{center}
جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال}  اور جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال_الف} میں متصل (قریب)  پتہ کی دیگر  ہدایات پیش ہیں۔

درج ذیل ہدایت  میں  مطلوبہ مواد، حافظہ کے بجائے  دفتر میں پایا جاتا ہے۔ یہ\اصطلاح{ دفتری پتہ  انداز}\فرہنگ{پتہ!دفتری انداز}\حاشیہب{register addressing}\فرہنگ{addressing!register} کی مثال ہے۔
\begin{center}
\begin{tabular}{r}
\MOV{\regA}{\regB}
\end{tabular}
...
\اصطلاح{مضمر پتہ کے انداز }\فرہنگ{پتہ!مضمر انداز}\حاشیہب{implied addressing}\فرہنگ{addressing!implied}  میں مواد کا پتہ ہدایت کے اندر موجود ہو گا۔ مثال کے طور پر،
\begin{center}
\begin{tabular}{r}
\RAL
\end{tabular}
\end{center}
کہتی ہے دفتر \دفترالف کے  بِٹ  بائیں  گھمائیں۔ مواد دفتر \دفترالف میں موجود ہے؛ یہی وجہ ہے کہ مضمر پتہ  کے انداز میں رقم زیر عمل کی ضرورت نہیں ہوگی۔

\جزوحصہء{بائٹ}
 ہدایت کو  حافظہ میں رکھنے کے لیے  ایک یا ایک سے زیادہ بائٹ کی جگہ درکار ہو گی۔کمپیوٹر با کی ہدایات  کو \عددی{1}، \عددی{2}، یا \عددی{3} بائٹ جگہ چاہیے ہو گی۔ہر ہدایت کو درکار بائٹ،  جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال} اور جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال_الف}  میں ہر    بتائے  گئے ہیں۔ جیسا آپ دیکھ سکتے ہیں، \sADD ہدایت کو \عددی{1} بائٹ، \sANI ہدایت کو \عددی{2}  بائٹ، اور \sCALL ہدایت کو \عددی{3} بائٹ جگہ چاہیے، وغیرہ۔
...
حل:\quad
گنتکار کی ابتدائی قیمت تعین کرنے کی خاطر  \sMVI ہدایت  کی تعمیل ایک مرتبہ کی جاتی ہے۔ ہدایت \sDCR کی تعمیل \عددی{70} مرتبہ ہو گی۔  ہدایت \sJNZ پورے \عددی{69} مرتبہ شاخ لی گی اور ایک مرتبہ سیدھا گزرنے دے گی۔ جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال}  اور جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال_الف} میں \عددی{T} حال   کی تعداد پیش ہے، جنہیں استعمال کر کے  ذیلی معمولہ کی تعمیلی دورانیہ معلوم کرتے ہیں۔
\begin{center}
\begin{tabular}{rrr}
...
جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال}  اور جدول \حوالہ{جدول_کمپیوٹر_با_ہدایات_اور_ٹی_حال_الف} کے تحت اس ذیلی معمولہ میں مستعمل ہدایات کی لمبائی درج ذیل ہے۔
\begin{center}
...
اس معمولہ کی کُل  لمبائی  \عددی{8} بائٹ ہے۔ کمپیوٹر با کے نرم افزار کے طور پر اس معمولہ    کا ترجمہ مشینی زبان میں کر کے  \عددی{F010H} تا \عددی{F017H} پتے  پر رکھا جا سکتا ہے۔ ایسا کرنے کے بعد، \CALL{F010H} ہمیں \عددی{\SI{1}{\milli\second}} وقفہ  دے گا۔
 \انتہا{مثال}
 %---------------------------
 %ex 11.17
...
\end{tabular}
\end{center}
اندرونی دائرے کی تعمیل \عددی{100} مرتبہ ہو گی، اور کُل وقفہ  تقریباً \عددی{\SI{100}{\milli\second}} ہو گا۔ اس ذیلی معمولہ کو، جو \عددی{\SI{100}{\milli\second}} وقفہ دیتا ہے،  پتہ \عددی{F030H} تا \عددی{F03CH} پر رکھتے ہیں۔
 \انتہا{مثال}
 %--------------------------
 %ex11.18
 \ابتدا{مثال}
...
&\JNZ{دائرہ1}& ؛\دفترالف کو صفر کے لیے پرکھیں\\
&\RET&
\end{tabular}
\end{center}
حل:\quad
دائرہ3 سے گزر تقریباً \عددی{\SI{1}{\milli\second}} میں ہو گی۔ دائرہ3 سے دائرہ2  سو مرتبہ گرتا ہے  جو تقریباً \عددی{\SI{100}{\milli\second}} میں ہو گا۔ دائرہ2 سے دائرہ1 پورے دس مرتبہ گزرتا ہے، جو تقریباً ایک سیکنڈ \عددی{(\SI{1}{\second})} لیگا۔ یوں ذیلی معمولہ کُل ایک سیکنڈ وقفہ پیدا کرتا ہے۔

کیا آپ دیکھ سکتے ہیں، ہم کہاں جا رہے ہیں؟ ہم نے ایک سیکنڈ کا ذیلی معمولہ حاصل کر لیا ہے۔ اس کو \عددی{F040H} تا \عددی{F052H} پتے پر رکھتے ہیں۔ ایک سیکنڈ وقفہ پیدا کرنے کے لیے ہم \عددی{\CALL{F040H}} ہدایت استعمال کریں گے۔

اول ہدایت کو تبدیل کر کے درج ذیل بنانے سے دائرہ2 سے دائرہ1 سو مرتبہ گزرتا ہے، جو خود دائرہ0 سے سو مرتبہ گزرتا ہے۔حاصل ذیلی معمولہ  دس سیکنڈ کا وقفہ دے گا۔
 \begin{center}
\begin{tabular}{r}
\MVI{\regA}{64H}
\end{tabular}
...
جدول  \حوالہ{جدول_کمپیوٹر_با_دورانے} میں کمپیوٹر با کے وقتی دورانیے پیش ہیں۔ انہیں استعمال کر کے \عددی{\SI{1}{\milli\second}} تا \عددی{\SI{10}{\second}} وقفے حاصل ہوں گے۔
 ...
 %ex11.19
 \ابتدا{مثال}
چوراہے  پر نصب \اصطلاح{ آمد و رفت بتی }\فرہنگ{آمد و رفت بتی}\حاشیہب{traffic lights}\فرہنگ{traffic lights} گاڑیوں کی حرکت قابو کرتی ہے۔ یہ بتی \عددی{\SI{50}{\second}} کے لیے سبز، \عددی{\SI{6}{\second}}  کے لیے پیلی، اور \عددی{\SI{30}{\second}}  کے لیے  لال   رہتی  ہے۔ روزن \عددی{4} کے بِٹ \عددی{1}، \عددی{2}، اور \عددی{3} بالترتیب   سبز، پیلی، اور لال    بلب  روشن کرنے والے ادوار کو جاتی ہیں۔   اس بتی کو چلانے کے لیے برنامہ لکھیں۔
...
\end{align*}
ہم شکل  \حوالہ{شکل_کمپیوٹر_با_چوکور_موج} میں دکھائے گئے\اصطلاح{ چوکور موج  }\فرہنگ{چوکور موج}\حاشیہب{square wave}\فرہنگ{square wave} کی  طرح  اشارہ  روزن \عددی{4} کے بِٹ \عددی{5} پر بھیجیں گے۔  چوکور اشارہ \عددی{\SI{1911}{\micro\second}} کے لیے بلند، اور \عددی{\SI{1911}{\micro\second}} کے لیے پست ہو گا۔ بلند اور پست حصے ملا کر \عددی{\SI{3822}{\micro\second}} دیتے ہیں، جو \عددی{\SI{261.63}{\hertz}} تعدد دے گا۔  پیدا کردہ  آواز سائن نما ہونے کے بجائے چوکور ہے، لہٰذا  یہ  سریلی  نہیں ہو گی۔
...
\def\kA{1}
\def\kB{1.5}
\draw[thick](0,0)--++(\kB,0)--++(0,\kA)--++(\kB,0)--++(0,-\kA)--++(\kB,0)--++(0,\kA)--++(\kB,0)--++(0,-\kA)--++(\kB,0);
\draw[thin](\kB,-0.1)--++(0,-1)  (2*\kB,-0.1)--++(0,-1) (3*\kB,-0.1)--++(0,-0.5);
\draw[latex-,thin](\kB,-0.4)--++(-0.5,0);
\draw[latex-,thin](3*\kB,-0.4)--++(0.75,0)node[right]{$\SI{3822}{\micro\second}$};
\draw[latex-,thin](\kB,-0.9)--++(-0.6,0);
\draw[latex-,thin](2*\kB,-0.9)--++(0.75,0)node[right]{$\SI{1911}{\micro\second}$};
\end{tikzpicture}
...
&\NOP&؛ بالکل درست دورانیہ پیدا کرنے کے لیے\\
&\NOP&؛ بالکل درست دورانیہ پیدا کرنے کے لیے\\
...
%ex 11.21
\ابتدا{مثال}
مواد کی سلسلہ وار  ترسیل میں  بِٹوں  کا بہاؤ  ایک دوسرے کے بعد ہوتا ہے لہٰذا سلسلہ وار مواد کو بعض اوقات \اصطلاح{سلسلہ وار مواد کی  دھار }\فرہنگ{سلسلہ وار مواد کی دھار}\حاشیہب{serial data stream}\فرہنگ{serial data stream} کہتے ہیں۔  شکل  \حوالہ{شکل_کمپیوٹر_با_تعمیر}   (صفحہ \حوالہصفحہ{شکل_کمپیوٹر_با_تعمیر}) میں  سلسلہ وار مواد کی دھار سے  ، روزن \عددی{2} کے بِٹ \عددی{7} پر   ، مواد کی آمد تقریباً \عددی{600} بِٹ فی سیکنڈ سے  ہوتی  ہے۔ ایک برنامہ لکھیں جو  سلسلہ وار مواد کی دھار سے آٹھ  بِٹ حاصل کر کے انہیں حافظہ کے مقام   \عددی{2100H} میں متوازی  ذخیرہ کرے۔
...
\item
دائرہ \عددی{210} مرتبہ لینے کے لیے برنامے میں کیا تبدیلی کرنی ہو گی؟
\end{enumerate}
...
%Q11.20
\ابتدا{سوال}
روزن \عددی{4} کے بِٹ \عددی{4} پر \عددی{\SI{523.25}{\hertz}}  کی آواز پیدا کرنے کے لیے برنامہ لکھیں۔
\انتہا{سوال}
%--------------------------------
%Q11.21
\ابتدا{سوال}
