...
\newcommand{\kANDboxBigger}[5][u0]{	%cannot use double quotes as the pin names allocated here are used when using the ICs
\def\kref{#1}
\def\kshiftX{#2}
\def\kshiftY{#3}
\def\nny{#4}
...
\newcommand{\kSftzA}[3][u0]{
\def\kref{#1}
\def\ksec{A}
\def\p{p}			%pin tip
\kANDboxBigger[#1]{#2}{#3}{4}{0.4}
