...
پلٹ کار کو جمع گیٹ معلومات فراہم کرتا ہے جس کو دو ضرب گیٹ مواد فراہم کرتے ہیں۔ قابو اشارہ \عددی{\overline{\text{متوازی بھرائی}}} عام طور غیر فعال (بلند) رکھا جاتا ہے۔یوں دایاں ضرب گیٹ معذور جبکہ بایاں گیٹ مجاز ہو کر، بائیں پلٹ کار کا مخارج، جمع گیٹ کے راستے پلٹ کار کو فراہم کرتا ہے، جو ساعت کے اگلے کنارہ چڑھائی پر پلٹ کار میں درج ہو گا۔
 ...
 مواد \عددی{z_0} تا \عددی{z_3} پلٹ کار میں چڑھانے کے لیے \عددی{\overline{\text{متوازی بھرائی}}} پست کیا جاتا ہے۔ یوں پلٹ کار کو مواد فراہم کرنے والا بایاں ضرب گیٹ معذور جبکہ دایاں مجاز ہو گا۔ مجاز گیٹ متوازی مواد کو جمع گیٹ کے راستہ پلٹ کار تک پہنچاتا ہے۔
...
شکل \حوالہ{شکل_دفتر_عالمگیر_انتقال_دفتر} میں چار یکساں حصے ہیں، جن کی کارکردگی ایک سی  ہے۔دایاں حصہ پر غور کرتے ہیں۔
