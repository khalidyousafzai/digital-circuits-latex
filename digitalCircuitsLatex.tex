...
decorations.pathreplacing,external,shapes.misc,decorations.pathmorphing,patterns,circuits.logic.US,circuits.logic.IEC}
...
%
%\includeonly{./tex/digitalCircuitsPreface,./tex/prefaceFirstBook,./tex/binarySystem,./tex/basicMaths}%
%
\includeonly{./tex/basicMaths,./tex/booleanAlgebra}%
