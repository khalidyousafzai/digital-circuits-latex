...
%\includeonly{./tex/digitalCircuitsPreface,./tex/prefaceFirstBook,./tex/binarySystem,./tex/basicMaths,./tex/booleanAlgebra,./tex/karnaughMaps,./tex/combinationalLogicAndCircuits,./tex/synchronusSequentialLogic,./tex/registers,./tex/counters,./tex/memory,./tex/progammableLogicDevices}%
%
\includeonly{./tex/programmableLogicDevices}%
