...
\pgfplotsset{compat=1.18}						% 5 june 2026 onwards
...
\input{./tex/myDigitalUpRight.tex}
\input{./tex/myDigitalUpFacing.tex}
\input{./tex/myDigitalDownFacing.tex}
\input{./tex/myAssemblyLanguage.tex}
%\input{./tex/myUrduShortLetters.tex}
\input{./tex/myDigitalGates.tex}
\input{./tex/myDigitalGatesAnchored.tex}
...
\includeonly{./tex/digitalCircuitsPreface,./tex/binarySystem,./tex/basicMaths,./tex/booleanAlgebra,./tex/karnaughMaps,./tex/combinationalLogicAndCircuits,./tex/synchronusSequentialLogic,./tex/registers,./tex/counters,./tex/memory,./tex/programmableLogicDevices,./tex/asynchronousCombinationalCircuits,./tex/simplestComputerOne,./tex/simplestComputerTwo}%
%
%\includeonly{./tex/simplestComputerOne,./tex/simplestComputerTwo}%
%\includeonly{,./tex/simplestComputerTwo}%
%\includeonly{./tex/booleanAlgebra}%
...
%the following handles the ref flipping bug. i have corrected it in \حوالہ{} command instead
\setlatin
...
\include{./tex/digitalCircuitsPreface}
\newpage
...
\include{./tex/binarySystem}
\include{./tex/basicMaths}
\include{./tex/booleanAlgebra}
\include{./tex/karnaughMaps}
\include{./tex/combinationalLogicAndCircuits}
\include{./tex/synchronusSequentialLogic}
\include{./tex/registers}
\include{./tex/counters}
\include{./tex/memory}
\include{./tex/programmableLogicDevices}
\include{./tex/asynchronousCombinationalCircuits}
\include{./tex/simplestComputerOne}
\include{./tex/simplestComputerTwo}
%\include{./tex/test}
...
%\end{thebibliography}
%============================================================
%%the following puts answer here. un-comment to make effective  
\begin{comment}
\chapter*{جوابات}
