...
%
%\includeonly{./tex/digitalCircuitsPreface,./tex/prefaceFirstBook,./tex/binarySystem,./tex/basicMaths,./tex/booleanAlgebra,./tex/karnaughMaps,./tex/combinationalLogicAndcircuits,./tex/synchronusSequentialLogic,./tex/registers}%
\includeonly{./tex/digitalCircuitsPreface,./tex/prefaceFirstBook,./tex/binarySystem,./tex/basicMaths,./tex/booleanAlgebra,./tex/karnaughMaps,./tex/combinationalLogicAndcircuits,./tex/synchronusSequentialLogic,./tex/registers,./tex/counters}%
%
%\includeonly{./tex/synchronusSequentialLogic}%
%\includeonly{,./tex/registers}%
